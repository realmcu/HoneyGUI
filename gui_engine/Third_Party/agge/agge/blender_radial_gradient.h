...
public:
    blender_radial_gradient(float cx, float cy, float inr, float outr, pixel32_rgba sc,
                            pixel32_rgba ec);
...
template <typename PixelT>
inline blender_radial_gradient<PixelT>::blender_radial_gradient(float cx, float cy, float inr,
                                                                float outr,
