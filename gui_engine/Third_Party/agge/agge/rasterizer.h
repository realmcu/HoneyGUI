...
struct scaling<real_t>
{
    ...
    static void scale2(real_t x1, real_t y1, real_t x2, real_t y2, int &cx1, int &cy1, int &cx2,
                       int &cy2)
    {
...
template <typename ClipperT, typename ScalingT>
inline void rasterizer<ClipperT, ScalingT>::line(coord_type x1, coord_type y1, coord_type x2,
                                                 coord_type y2)
{
    int cx1, cy1, cx2, cy2;
