...
typedef struct jerryx_native_module_t
{
    ...
    const jerryx_native_module_on_resolve_t
    on_resolve_p; /**< function that returns a new instance of the module */
 ...
 */
typedef jerry_value_t (*jerryx_module_get_canonical_name_t)(const jerry_value_t
                                                            name); /**< The name for which to
 ...
 */
typedef bool (*jerryx_module_resolve_t)(const jerry_value_t
                                        canonical_name,  /**< The module's canonical name */
...
typedef struct
{
    ...
    get_canonical_name_p; /**< function pointer to establish the canonical name of a
                                                            *   module */
