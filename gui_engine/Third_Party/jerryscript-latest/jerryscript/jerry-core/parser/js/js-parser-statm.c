...
typedef struct
{
    ...
    *branch_list_p;    /**< list of breaks and continues targeting this statement */
...
{
    JERRY_ASSERT(iterator->current_position > 0 &&
...
parser_parse_do_while_statement_end(parser_context_t *context_p)  /**< context */
{
    ...
    parser_stack_pop(context_p, NULL,
                     1 + sizeof(parser_loop_statement_t) + sizeof(parser_do_while_statement_t));
    parser_stack_iterator_init(context_p, &context_p->last_statement);
...
parser_parse_while_statement_end(parser_context_t *context_p)  /**< context */
{
    ...
    parser_stack_pop(context_p, NULL,
                     1 + sizeof(parser_loop_statement_t) + sizeof(parser_while_statement_t));
    parser_stack_iterator_init(context_p, &context_p->last_statement);
...
parser_parse_for_statement_end(parser_context_t *context_p)  /**< context */
{
    ...
    parser_stack_pop(context_p, NULL,
                     1 + sizeof(parser_loop_statement_t) + sizeof(parser_for_statement_t));
    parser_stack_iterator_init(context_p, &context_p->last_statement);
