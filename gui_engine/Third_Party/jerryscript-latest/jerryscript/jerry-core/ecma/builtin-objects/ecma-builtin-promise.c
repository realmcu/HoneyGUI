                                       ...
                                       bool is_resolve) /**< whether it is for resolve routine */
{
    ...
    ecma_value_t promise_new = ecma_op_object_get(ecma_get_object_from_value(capability),
                                                  promise_str_p);
                             ...
                             ecma_value_t ctor) /**< the caller of Promise.race */
{
    ...
    JERRY_ASSERT(ecma_get_object_builtin_id(ecma_get_object_from_value(ctor)) ==
                                          ...
                                          bool is_inc) /**< whether to increase the count */
{
    ...
    ecma_length_t current = (ecma_length_t) ecma_get_integer_from_value(
                                 ...
                                 const ecma_length_t argc) /**< argument number */
{
    ...
    ecma_string_t *already_called_str_p = ecma_get_ecma_string_from_uint32(
    ...
    ecma_string_t *str_capability_p = ecma_get_ecma_string_from_uint32(
                                          ECMA_PROMISE_PROPERTY_CAPABILITY);
    ecma_string_t *str_remaining_p = ecma_get_ecma_string_from_uint32(
    ...
    /* 8. */
    ecma_string_t *index_to_str_p = ecma_new_ecma_string_from_uint32((uint32_t)
                                                                     ecma_get_integer_from_value(index_val));
                            ...
                            ecma_value_t ctor) /**< the caller of Promise.race */
{
    ...
    ecma_string_t *capability_str_p = ecma_get_ecma_string_from_uint32(
                                          ECMA_PROMISE_PROPERTY_CAPABILITY);
    ecma_string_t *remaining_str_p = ecma_get_ecma_string_from_uint32(
                                         ECMA_PROMISE_PROPERTY_REMAINING_ELEMENT);
 ...
 */
ecma_value_t
ecma_builtin_promise_dispatch_construct(const ecma_value_t
                                        *arguments_list_p,  /**< arguments list */
                                        ecma_length_t arguments_list_len) /**< number of arguments */
{
    JERRY_ASSERT(arguments_list_len == 0 || arguments_list_p != NULL);
