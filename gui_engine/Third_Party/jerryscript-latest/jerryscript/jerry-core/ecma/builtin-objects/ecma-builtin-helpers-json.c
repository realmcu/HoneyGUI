...
ecma_builtin_helper_json_create_separated_properties(ecma_collection_header_t
                                                     *partial_p,  /**< key-value pairs*/
 ...
 */
ecma_value_t
ecma_builtin_helper_json_create_formatted_json(lit_utf8_byte_t
                                               ...
                                               ecma_json_stringify_context_t *context_p) /**< context*/
{
    ...
    /* 10.b.ii */
    ecma_string_t *properties_str_p = ecma_builtin_helper_json_create_separated_properties(partial_p,
                                      separator_p);
 ...
 */
ecma_value_t
ecma_builtin_helper_json_create_non_formatted_json(lit_utf8_byte_t
                                                   left_bracket,  /**< left bracket character */
                                                   lit_utf8_byte_t right_bracket, /**< right bracket character */
                                                   ecma_collection_header_t *partial_p) /**< key-value pairs */
{
