...
ROUTINE(LIT_MAGIC_STRING_TO_LOCALE_STRING_UL, ecma_builtin_array_prototype_object_to_locale_string,
        0, 0)
...
ROUTINE(LIT_MAGIC_STRING_LAST_INDEX_OF_UL, ecma_builtin_array_prototype_object_last_index_of,
        NON_FIXED, 1)
...
ROUTINE(LIT_MAGIC_STRING_REDUCE_RIGHT_UL, ecma_builtin_array_prototype_object_reduce_right,
        NON_FIXED, 1)
