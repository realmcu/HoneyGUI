...
ecma_value_t ecma_find_or_create_literal_string(const lit_utf8_byte_t *chars_p,
...
bool ecma_save_literals_for_snapshot(ecma_collection_header_t *lit_pool_p, uint32_t *buffer_p,
                                     size_t buffer_size,
