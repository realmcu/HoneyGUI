 ...
 */
void
ecma_save_literals_add_compiled_code(const ecma_compiled_code_t
                                     *compiled_code_p,  /**< byte-code data */
                                     ecma_collection_header_t *lit_pool_p) /**< list of known values */
{
                                ...
                                uint32_t *out_map_len_p) /**< [out] number of literals */
{
    ...
    *out_map_len_p = total_count;
    ...
    while (iterator_p != NULL)
    {
        ...
        map_p->literal_offset = (literal_offset << JERRY_SNAPSHOT_LITERAL_SHIFT) |
                                ECMA_TYPE_SNAPSHOT_OFFSET;
