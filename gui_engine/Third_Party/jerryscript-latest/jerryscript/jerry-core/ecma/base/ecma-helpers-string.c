...
ecma_new_ecma_string_from_magic_string_ex_id(lit_magic_string_ex_id_t
                                             id)  /**< identifier of externl magic string */
{
                               ...
                               lit_utf8_size_t string_size) /**< string size */
{
    ...
    else
    {
        ...
        string_desc_p->refs_and_container = ECMA_STRING_CONTAINER_HEAP_LONG_UTF8_STRING |
                                            ECMA_STRING_REF_ONE;
        string_desc_p->u.common_uint32_field = 0;
 ...
 */
ecma_string_t *
ecma_new_ecma_string_from_utf8_converted_to_cesu8(const lit_utf8_byte_t
                                                  *string_p,  /**< utf-8 string */
    ...
    else
    {
        ...
        while (pos < string_size)
        {
            if ((string_p[pos] & LIT_UTF8_4_BYTE_MASK) == LIT_UTF8_4_BYTE_MARKER)
            {
                ...
                data_p += lit_char_to_utf8_bytes(data_p,
    ...
    case ECMA_STRING_CONTAINER_HEAP_LONG_UTF8_STRING:
        {
            ...
            ecma_dealloc_string_buffer(string_p,
                                       string_p->u.long_utf8_string_size + sizeof(ecma_long_string_t));
            return;
        }
 ...
 */
lit_utf8_size_t
ecma_substring_copy_to_cesu8_buffer(const ecma_string_t
                                    *string_desc_p,  /**< ecma-string descriptor */
 ...
 */
lit_utf8_size_t
ecma_substring_copy_to_utf8_buffer(const ecma_string_t
                                   *string_desc_p,  /**< ecma-string descriptor */
                                   ecma_length_t start_pos, /**< position of the first character */
                                   ecma_length_t end_pos, /**< position of the last character */
                                   lit_utf8_byte_t *buffer_p, /**< destination buffer pointer
...
{
    JERRY_ASSERT(string_desc_p != NULL);
    JERRY_ASSERT(ECMA_IS_DIRECT_STRING(string_desc_p) ||
                 string_desc_p->refs_and_container >= ECMA_STRING_REF_ONE);
    JERRY_ASSERT(buffer_p != NULL || buffer_size == 0);
                        ...
                        jmem_cpointer_t prop_name_cp) /**< property name compressed pointer */
{
    ...
    return (ecma_string_t *)(property_string | (((uintptr_t) prop_name_cp) <<
                                                ECMA_DIRECT_STRING_SHIFT));
    ...
    default:
        {
            ...
            return lit_get_utf8_length_of_cesu8_string(lit_get_magic_string_ex_utf8(
                                                           string_p->u.magic_string_ex_id),
                                                       lit_get_magic_string_ex_size(string_p->u.magic_string_ex_id));
        }
    }
