                ...
                ecma_value_t key_arg) /**< key argument */
{
    ...
    return ecma_make_boolean_value(ecma_builtin_map_search(map_object_p->first_chunk_cp,
                                                           key_arg) != NULL);
} /* ecma_op_map_has */
                         ...
                         ecma_map_object_chunk_t *prev_chunk_p) /**< previous chunk */
{
    ...
    ecma_map_object_chunk_t *next_chunk_p = (ecma_map_object_chunk_t *) ecma_get_pointer_from_value(
                                                next_chunk);
    ...
    if (prev_chunk_p != NULL)
    {
        ...
        if (next_chunk_p == NULL)
        {
            ...
            JERRY_ASSERT(ECMA_GET_NON_NULL_POINTER(ecma_map_object_chunk_t,
                                                   map_object_p->last_chunk_cp) == chunk_p);
                   ...
                   ecma_value_t key_arg) /**< key argument */
{
    ...
    ecma_map_object_chunk_t *next_chunk_p = ecma_op_map_delete_chunk(map_object_p, chunk_p,
                                                                     prev_chunk_p);
