...
struct jerry_context_t
{
    ...
    ecma_object_t
    *ecma_builtin_objects[ECMA_BUILTIN_ID__COUNT]; /**< pointer to instances of built-in objects */
    ...
    jerry_context_data_header_t
    *context_data_p; /**< linked list of user-provided context-specific pointers */
    ...
    *debugger_transport_header_p; /**< head of transport protocol chain */
    ...
    vm_frame_ctx_t
    *debugger_stop_context; /**< stop only if the current context is equal to this context */
