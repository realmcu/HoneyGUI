                         ...
                         size_t eval_string_size) /**< evaluated string size */
{
    ...
    ecma_value_t result = ecma_op_eval_chars_buffer(eval_string_p + 1, eval_string_size - 1,
                                                    ECMA_PARSE_DIRECT_EVAL);
    ...
    case JERRY_DEBUGGER_UPDATE_BREAKPOINT:
        {
            ...
            *byte_code_p = update_breakpoint_p->is_set_breakpoint ? CBC_BREAKPOINT_ENABLED :
    ...
    case JERRY_DEBUGGER_EVAL:
        {
            ...
            if (eval_size <= JERRY_CONTEXT(debugger_max_receive_size) - sizeof(
            ...
            eval_uint8_data_p->uint8_offset = (uint32_t)(message_size - sizeof(
                                                             jerry_debugger_receive_eval_first_t));
    ...
    case JERRY_DEBUGGER_CLIENT_SOURCE:
        {
            ...
            JERRY_DEBUGGER_RECEIVE_BUFFER_AS(jerry_debugger_receive_client_source_first_t,
                                             client_source_first_p);
            ...
            client_source_data_p = (jerry_debugger_uint8_data_t *) jmem_heap_alloc_block(
                                       client_source_data_size);
...
jerry_debugger_receive(jerry_debugger_uint8_data_t
                       **message_data_p)  /**< [out] data received from client */
{
    JERRY_ASSERT(jerry_debugger_transport_is_connected());

    JERRY_ASSERT(message_data_p != NULL ? !!(JERRY_CONTEXT(debugger_flags) &
...
jerry_debugger_exception_object_to_string(ecma_value_t
                                          exception_obj_value)  /**< exception object */
{
