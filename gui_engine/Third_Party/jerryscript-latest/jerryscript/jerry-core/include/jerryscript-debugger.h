 ...
 */
typedef jerry_value_t (*jerry_debugger_wait_for_source_callback_t)(const jerry_char_t
                                                                   *resource_name_p,
...
void jerry_debugger_send_log(jerry_log_level_t level, const jerry_char_t *buffer,
