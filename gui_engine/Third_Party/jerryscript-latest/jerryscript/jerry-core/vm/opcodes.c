                  ...
                  bool is_strict) /**< strict mode */
{
    ...
    JERRY_ASSERT(ecma_is_value_boolean(delete_op_ret) || (is_strict == true &&
                                                          ECMA_IS_VALUE_ERROR(delete_op_ret)));
              ...
              ecma_value_t *result_obj_p) /**< expression object */
{
    ...
    ecma_collection_header_t *prop_names_coll_p = ecma_op_object_get_property_names(obj_p, false, true,
                                                                                    true);
