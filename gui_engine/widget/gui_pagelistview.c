...
static void prepare(gui_pagelistview_t *this)
{

}

static void draw(gui_pagelistview_t *this)
{

}
static void end(gui_pagelistview_t *this)
{

}
static void destory(gui_pagelistview_t *this)
{
...
static void pagelistview_ctor(gui_pagelistview_t *this, gui_obj_t *parent, const char *name,
                                            ...
                                            int16_t y, int16_t w, int16_t h)
{
    ...
    pagelistview_ctor(this, (gui_obj_t *)parent, name, x, y, w, h);
