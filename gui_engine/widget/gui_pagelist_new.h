...
*****************************************************************************************
  ...
  * @brief pagelist widget sample at APP_PAGE_LIST gui_engine\example\screen_454_454\gui_menu\apps_in_menu.c
 ...
 *
 * This function initializes and creates a new vertical pagelist with the specified parameters. Sample at APP_PAGE_LIST gui_engine\example\screen_454_454\gui_menu\apps_in_menu.c
 *
 ...
 *
 * This function renders the pagelist with the provided items, their click functions, and their text labels. Sample at APP_PAGE_LIST gui_engine\example\screen_454_454\gui_menu\apps_in_menu.c
 *
 ...
 *
 * This function initializes and creates a new horizontal pagelist with the specified parameters. Sample at APP_PAGE_LIST gui_engine\example\screen_454_454\gui_menu\apps_in_menu.c
 *
 * @param parent Pointer to the parent GUI object.
 * @param x The X coordinate of the pagelist.
 * @param y The Y coordinate of the pagelist.
