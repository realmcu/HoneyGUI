...
static bool creat_stb_screen(gui_text_t *text, rtgui_rect_t *rect, FONT_STB_SCREEN *screen)
{
...
#endif
static void rtgui_font_stb_draw(gui_text_t *text, rtgui_rect_t *rect)
{
