...
//    int16_t source_h = image->img_h;
    ...
    if (img_type == 4)//rle_cover_565_2_565
    {
    ...
    else if (img_type == 68) //rle_cover_rgb888_2_rgb565
    {
    ...
    else if (img_type == 132) //rle_cover_argb8888_2_rgb565
    {
...
//    int16_t source_h = image->img_h;
    ...
    if (img_type == 132)//rle_cover_rgba8888_rgb888
    {
        uint8_t source_bytes_per_pixel = 4;
        uint8_t line_buf[source_bytes_per_pixel * source_w];
        imdc_file_t *file = (imdc_file_t *)image_off;
    ...
    else if (img_type == 68) //rle_cover_rgb888_2_rgb888
    {
        uint8_t source_bytes_per_pixel = 3;
        uint8_t line_buf[source_bytes_per_pixel * source_w];
        imdc_file_t *file = (imdc_file_t *)image_off;
    ...
    else if (img_type == 4) //rle_cover_rgb565_2_rgb888
    {
        uint8_t source_bytes_per_pixel = 2;
        uint8_t line_buf[source_bytes_per_pixel * source_w];
        imdc_file_t *file = (imdc_file_t *)image_off;
...
//    int16_t source_h = image->img_h;
    ...
    else if (img_type == 68) //rle_cover_rgb888_2_argb8888
    {
        uint8_t source_bytes_per_pixel = 3;
        uint8_t line_buf[source_bytes_per_pixel * source_w];
        imdc_file_t *file = (imdc_file_t *)image_off;
    ...
    else if (img_type == 4) //rle_cover_rgb565_2_argb8888
    {
        uint8_t source_bytes_per_pixel = 2;
        uint8_t line_buf[source_bytes_per_pixel * source_w];
        imdc_file_t *file = (imdc_file_t *)image_off;
