...
*****************************************************************************************
  * @file acc_sw_rle_filter_matrix.c
...
//                   inverse->m[0][2]);
    ...
    if (img_type == RGB565)//rle_filter_matrix_rgb565_2_rgb565
    {
    ...
    else if (img_type == RGB888) //rle_filter_matrix_rgb888_2_rgb565
    {
...
//            int line = y_i - image_y;
    ...
    else if (img_type == RGBA8888) //rle_filter_matrix_argb8888_2_rgb565
    {
...
//                   inverse->m[0][2]);
    ...
    //TODO: y2 + ceil(1 / scale_y_ratio)
    if (img_type == RGBA8888)//rle_filter_matrix_rgba8888_2_rgb888
    {
        uint8_t source_bytes_per_pixel = 4;
        uint8_t line_buf[source_bytes_per_pixel * source_w * (end_line - start_line + 1)];
        imdc_file_t *file = (imdc_file_t *)image_off;
...
//            int line = y_i - image_y;
    ...
    else if (img_type == RGB888) //rle_filter_matrix_rgb888_2_rgb888
    {
...
//            int line = y_i - image_y;
    ...
    else if (img_type == RGB565) //rle_filter_matrix_rgb565_2_rgb888
    {
        uint8_t source_bytes_per_pixel = 2;
        uint8_t line_buf[source_bytes_per_pixel * source_w * (end_line - start_line + 1)];
        imdc_file_t *file = (imdc_file_t *)image_off;
...
//                   inverse->m[0][2]);
    ...
    //TODO: y2 + ceil(1 / scale_y_ratio)
    if (img_type == RGBA8888)//filter_matrix_rgba8888_2_argb8888
    {
        uint8_t source_bytes_per_pixel = 4;
        uint8_t line_buf[source_bytes_per_pixel * source_w * (end_line - start_line + 1)];
        imdc_file_t *file = (imdc_file_t *)image_off;
...
//            int line = y_i - image_y;
    ...
    else if (img_type == RGB888) //filter_matrix_rgb888_2_argb8888
    {
...
//            int line = y_i - image_y;
    ...
    else if (img_type == RGB565) //matrix_rgb565_2_argb8888
    {
        uint8_t source_bytes_per_pixel = 2;
        uint8_t line_buf[source_bytes_per_pixel * source_w * (end_line - start_line + 1)];
        imdc_file_t *file = (imdc_file_t *)image_off;
