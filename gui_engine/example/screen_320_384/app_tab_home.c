...
void switch_dynamic_island(void *obj, gui_event_t e)
{
    ...
    {
        dynamic_island_rect = gui_img_creat_from_mem(dynamic_island, "dynamic_island_rect1",
                                                     DYNAMIC_ISLAND_POINT_BIN, 107, 35, 0, 0);
    }
    else if (dynamic_island_count == 2)
    {
        gui_tree_free((gui_obj_t *)dynamic_island_rect);
        dynamic_island_rect = gui_img_creat_from_mem(dynamic_island, "dynamic_island_rect2",
                                                     DYNAMIC_ISLAND_PIC1_BIN, -10, 25, 0, 0);
        // dynamic_island_rect = gui_img_creat_from_mem(dynamic_island, "dynamic_islcand_pic0",
        //                                                     DYNAMIC_ISLAND_260_66_BIN, 30, 25, 0, 0);
        // gui_magic_img_t *dynamic_islcand_pic1 = gui_img_creat_from_mem(dynamic_island_rect, "dynamic_islcand_pic1",
        //                                                     DYNAMIC_ISLAND_MUSIC_BIN, 10, 10, 0, 0);
        // gui_magic_img_t *dynamic_islcand_pic2 = gui_img_creat_from_mem(dynamic_island_rect, "dynamic_islcand_pic2",
        //                                                     DYNAMIC_ISLAND_RECORDING_START_BIN, 204, 10, 0, 0);
    }
    else if (dynamic_island_count == 3)
    {
        gui_tree_free((gui_obj_t *)dynamic_island_rect);
        dynamic_island_rect = gui_img_creat_from_mem(dynamic_island, "dynamic_island_rect3",
    ...
    {
        gui_tree_free((gui_obj_t *)dynamic_island_rect);
        dynamic_island_rect = gui_img_creat_from_mem(dynamic_island, "dynamic_island_rect40",
                                                     DYNAMIC_ISLAND_PIC3_BIN, -10, 25, 0, 0);
        // dynamic_island_rect = gui_img_creat_from_mem(dynamic_island, "dynamic_islcand_pic0",
        //                                                     DYNAMIC_ISLAND_260_66_BIN, 30, 25, 0, 0);
        gui_magic_img_t *dynamic_islcand_pic1 = gui_img_creat_from_mem(dynamic_island_rect,
    ...
    {
        gui_tree_free((gui_obj_t *)dynamic_island_rect);
        dynamic_island_rect = gui_img_creat_from_mem(dynamic_island, "dynamic_island_rect5",
    ...
    {
        gui_tree_free((gui_obj_t *)dynamic_island_rect);
        dynamic_island_rect = gui_img_creat_from_mem(dynamic_island, "dynamic_island_rect6",
                                                     DYNAMIC_ISLAND_260_66_BIN, -10, 25, 0, 0);
        gui_magic_img_t *dynamic_islcand_pic1 = gui_img_creat_from_mem(dynamic_island_rect,
                                                                       "dynamic_island_rect_pic1",
                                                                       DYNAMIC_ISLAND_SPORT_BIN, 10, 10, 0, 0);
        gui_magic_img_t *dynamic_islcand_pic2 = gui_img_creat_from_mem(dynamic_island_rect,
                                                                       "dynamic_island_rect_pic2",
                                                                       DYNAMIC_ISLAND_BPM_ICON_BIN, 82, 12, 0, 0);
        gui_magic_img_t *dynamic_islcand_pic3 = gui_img_creat_from_mem(dynamic_island_rect,
                                                                       "dynamic_island_rect_pic3",
                                                                       DYNAMIC_ISLAND_BPM_NUM_BIN, 112, 14, 0, 0);
        gui_magic_img_t *dynamic_islcand_pic4 = gui_img_creat_from_mem(dynamic_island_rect,
                                                                       "dynamic_island_rect_pic4",
                                                                       DYNAMIC_ISLAND_BPM_BIN, 146, 14, 0, 0);
        gui_magic_img_t *dynamic_islcand_pic5 = gui_img_creat_from_mem(dynamic_island_rect,
                                                                       "dynamic_island_rect_pic5",
                                                                       DYNAMIC_ISLAND_STEPS_ICON_BIN, 82, 40, 0, 0);
        gui_magic_img_t *dynamic_islcand_pic6 = gui_img_creat_from_mem(dynamic_island_rect,
                                                                       "dynamic_island_rect_pic6",
                                                                       DYNAMIC_ISLAND_STEPS_NUM_BIN, 112, 40, 0, 0);
        gui_magic_img_t *dynamic_islcand_pic7 = gui_img_creat_from_mem(dynamic_island_rect,
...
{
    home_bg = gui_img_creat_from_mem(parent, "home_bg", home[0], 0,
                                     0, 0, 0);
    hour = gui_img_creat_from_mem(parent, "hour", TIME_HOUR_BIN, 160, 192, 0, 0);
    minute = gui_img_creat_from_mem(parent, "minute", TIME_MUNITE_BIN, 160, 192, 0, 0);
    second = gui_img_creat_from_mem(parent, "second", TIME_SECOND_BIN, 160, 192, 0, 0);
