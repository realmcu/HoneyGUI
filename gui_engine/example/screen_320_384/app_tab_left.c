...
void  page_left_figure(void *parent)
{
    ...
    gui_img_t *background =  gui_img_create_from_mem(parent, "background_left",
                                                     ...
                                                     72, 0, 0, 0);
#else
    gui_magic_img_t *background =  gui_img_creat_from_mem(parent, "background_left",
                                                          RECT_248_384_BIN,
                                                          72, 0, 0, 0);
#endif // RTL87x2G
    ...
    gui_img_t *figure_bk0 =  gui_img_create_from_mem(parent, "figure_bk0", ZIP_RECT_110_108_BIN,
                                                     82, 98, 0, 0);
#else
    gui_magic_img_t *figure_bk0 =  gui_img_creat_from_mem(parent, "figure_bk0", RECT_110_108_BIN,
                                                          82, 98, 0, 0);
#endif // RTL87x2G
    ...
    gui_img_t *figure_bk1 =  gui_img_create_from_mem(parent, "figure_bk1", ZIP_RECT_228_64_BIN,
                                                     82, 214, 0, 0);
#else
    gui_magic_img_t *figure_bk1 =  gui_img_creat_from_mem(parent, "figure_bk1", RECT_228_64_BIN,
                                                          82, 214, 0, 0);
#endif // RTL87x2G
