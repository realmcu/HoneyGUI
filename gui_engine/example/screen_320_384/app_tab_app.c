...
{
    gui_magic_img_t *home_bg = gui_magic_img_create_from_mem(parent, "design_tab_heart",
                                                             app_image_list[1], 0,
                                                             0, 0, 0);
}
void design_tab_blood(void *parent)
{
    gui_magic_img_t *home_bg = gui_magic_img_create_from_mem(parent, "design_tab_blood",
                                                             app_image_list[2], 0,
                                                             0, 0, 0);
}
void design_tab_call(void *parent)
{
    gui_magic_img_t *home_bg = gui_magic_img_create_from_mem(parent, "design_tab_call",
                                                             app_image_list[3], 0, 0, 0,
                                                             0);
}
void design_tab_music(void *parent)
{
    gui_magic_img_t *home_bg = gui_magic_img_create_from_mem(parent, "design_tab_music",
                                                             app_image_list[4], 0, 0, 0,
                                                             0);
}
void design_tab_note(void *parent)
{
    gui_magic_img_t *home_bg = gui_magic_img_create_from_mem(parent, "design_tab_note",
                                                             app_image_list[5], 0,
                                                             0, 0, 0);
}
void design_tab_weather(void *parent)
{
    gui_magic_img_t *home_bg = gui_magic_img_create_from_mem(parent, "design_tab_weather",
                                                             app_image_list[6], 0, 0,
                                                             0, 0);
}
void design_tab_breath(void *parent)
{
    gui_magic_img_t *home_bg = gui_magic_img_create_from_mem(parent, "design_tab_breath",
                                                             app_image_list[7], 0, 0, 0,
                                                             0);
}
void design_tab_sleep(void *parent)
{
    gui_magic_img_t *home_bg = gui_magic_img_create_from_mem(parent, "design_tab_sleep",
