...
{
#ifdef RTL87x2G
    gui_magic_img_t *bg = gui_img_creat_from_mem(parent_widget, "bg_up", ZIP_RECT_320_384_BIN, 0,
                                                 0,
                                                 0, 0);
#else
    gui_magic_img_t *bg = gui_img_creat_from_mem(parent_widget, "bg_up", RECT_320_384_BIN, 0, 0,
                                                 0, 0);
#endif // RTL87x2G
