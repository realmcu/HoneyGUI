...
void page_tb_conn(void *parent)
{
    ...
    gui_text_set(button_text1, text1, GUI_FONT_SRC_BMP, gui_obj_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text1), 24);
    ...
    gui_text_set(button_text2, text2, GUI_FONT_SRC_BMP, gui_obj_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text2), 24);
    ...
    gui_text_set(button_text3, text3, GUI_FONT_SRC_BMP, gui_obj_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text3), 24);
    ...
    gui_text_set(button_text4, text4, GUI_FONT_SRC_BMP, gui_obj_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text4), 24);
    ...
    gui_text_set(button_text5, text5, GUI_FONT_SRC_BMP, gui_obj_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text5), 24);
    ...
    gui_text_set(button_text6, text6, GUI_FONT_SRC_BMP, gui_obj_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text6), 24);
    ...
    gui_text_set(button_text7, text7, GUI_FONT_SRC_BMP, gui_obj_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text7), 24);
