...
void page_tb_func(void *parent)
{
    ...
    gui_text_set(t1, text1, GUI_FONT_SRC_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text1),
                 24);
    ...
    gui_text_set(t2, text2, GUI_FONT_SRC_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text2),
                 24);
    ...
    gui_text_set(t3, text3, GUI_FONT_SRC_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text3),
                 24);
    ...
    gui_text_set(t4, text4, GUI_FONT_SRC_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text4),
                 24);
    // gui_text_type_set(t4, SIMKAI_SIZE24_BITS4_FONT_BIN);
    char *text5 = "ANC:      ON";
    gui_text_t *t5 = gui_text_create(parent, "txt", 20, 175, gui_get_screen_width(), 24);
    gui_text_set(t5, text5, GUI_FONT_SRC_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                 strlen(text5),
                 24);
