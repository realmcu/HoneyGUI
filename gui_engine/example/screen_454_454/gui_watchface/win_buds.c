...
void design_win_menu_buds(void *parent)
{
    ...
    gui_text_set(text_buds_title, "连接耳机", "rtk_font_mem", APP_COLOR_WHITE, 12, font_size);
    ...
    gui_text_set(text_buds_device, "耳机设备名称", "rtk_font_mem", APP_COLOR_WHITE, 18,
                 font_size);
    ...
    gui_text_set(text_search_buds, "搜索耳机", "rtk_font_mem", APP_COLOR_WHITE, 12, font_size);
    ...
    gui_text_set(text_disconnect, "断开连接", "rtk_font_mem", APP_COLOR_WHITE, 12, font_size);
