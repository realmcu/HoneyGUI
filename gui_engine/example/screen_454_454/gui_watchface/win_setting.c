...
void design_win_menu_setting(void *parent)
{
    ...
    switch_connect_more = gui_switch_create(parent, 271, 115, 100, 60, ICON_SWITCH_OFF_BIN,
                                            ICON_SWITCH_ON_BIN);
    gui_obj_add_event_cb(switch_connect_more,
                         (gui_event_cb_t)switch_connect_more_on_touch_cb, GUI_EVENT_1, NULL);
    gui_obj_add_event_cb(switch_connect_more,
                         (gui_event_cb_t)switch_connect_more_off_touch_cb, GUI_EVENT_2, NULL);
    ...
    gui_text_set(text_setting_title, "设置", "rtk_font_mem", APP_COLOR_WHITE, 6, font_size);
    ...
    gui_text_set(text_connect_more, "连接更多", "rtk_font_mem", APP_COLOR_WHITE, 12, font_size);
    ...
    gui_text_set(text_sw_reset, "Reset", "rtk_font_mem", APP_COLOR_WHITE, 5, font_size);
    ...
    text_factory_data_reset = gui_text_create(parent, "text_factory_data_reset", 131, 286, 192,
                                              font_size);
    gui_text_set(text_factory_data_reset, "恢复出厂设置", "rtk_font_mem", APP_COLOR_WHITE, 18,
                 font_size);
