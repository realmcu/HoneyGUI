...
void design_win_song_lists(gui_win_t *parent)
{
    ...
    gui_text_set(text_song_list_title, string_song_list_title, "rtk_font_mem", APP_COLOR_WHITE,
    ...
    for (uint8_t i = 0; i < 3; i++)
    {
        ...
        gui_text_set(text_song[i], song_files_name[i], "rtk_font_mem", APP_COLOR_WHITE,
