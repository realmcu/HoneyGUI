...
void design_win_incoming_call(void *parent, char *dial_num)
{
    ...
    gui_text_set(text_incoming_call_title, string_incoming_call_title, "rtk_font_mem", 0xffffffff,
    ...
    text_incoming_call_num = gui_text_create(parent, "text_incoming_call_num", 0, 59,
                                             LCD_W, FONT_H_32);
    gui_text_set(text_incoming_call_num, string_dial_num, "rtk_font_mem", 0xffffffff,
