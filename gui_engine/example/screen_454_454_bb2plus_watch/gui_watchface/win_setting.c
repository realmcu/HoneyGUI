...
void design_win_menu_setting(void *parent)
{
    ...
    gui_text_set(text_setting_title, "设置", "rtk_font_mem", 0xffffffff, 6, font_size);
    ...
    gui_text_set(text_connect_more, "连接更多", "rtk_font_mem", 0xffffffff, 12, font_size);
    ...
    gui_text_set(text_sw_reset, "Reset", "rtk_font_mem", 0xffffffff, 5, font_size);
    ...
    text_factory_data_reset = gui_text_create(parent, "text_factory_data_reset", 131, 286, 192,
                                              font_size);
    gui_text_set(text_factory_data_reset, "恢复出厂设置", "rtk_font_mem", 0xffffffff, 18,
                 font_size);
