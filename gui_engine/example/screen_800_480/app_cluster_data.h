/*
 * File      : app_cluster_data.h
 */
#ifndef __APP_CLUSTER_DATA_H__
#define __APP_CLUSTER_DATA_H__
...
typedef struct app_cluster_data_t
{
...
static app_cluster_data app_current_cluster_data;
...
/**
 * \brief  Refresh the cluster application information
 * \param[in] None
 * \return None.
 */
...
/**
 * \brief  Get the cluster application information
 * \param[in] None
 * \return app_cluster_data*: Return the cluster application data
 */
...
void app_cluster_data_set_show_main_display(uint8_t Value, uint8_t le_event);
