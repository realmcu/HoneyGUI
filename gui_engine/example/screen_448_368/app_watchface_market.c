...
#if _WIN32
    defaultPath = "gui_engine\\example\\screen_448_368\\root_image_hongkong\\root\\";
    create_tree_nest("gui_engine\\example\\screen_448_368\\root_image_hongkong\\root\\watchface\\watchface410x502.xml",
                     win_market);
#else
