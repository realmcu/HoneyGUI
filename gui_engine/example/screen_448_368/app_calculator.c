...
static void cal_display_update(void)
{
    ...
    {
        // single line
        gui_text_set(text_display_up, NULL, GUI_FONT_SOURCE_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                     0,
                     CAL_TEXT_FONT_SIZE_DISPLAY);
        gui_text_set(text_display_dn, pstr, GUI_FONT_SOURCE_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                     len,
                     CAL_TEXT_FONT_SIZE_DISPLAY);
    }
    else
    {
        // double line
        gui_text_set(text_display_up, pstr, GUI_FONT_SOURCE_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
                     line_len,
                     CAL_TEXT_FONT_SIZE_DISPLAY);
        gui_text_set(text_display_dn, pstr + line_len, GUI_FONT_SOURCE_BMP, gui_rgb(UINT8_MAX, UINT8_MAX,
...
static void calculator_draw_button(void *parent)
{
    ...
    text_display_dn = gui_text_create(parent, "txt", 0, offset_y / 2 - 9, offset_x + del_x * 3 + 20,
                                      font_size);
    gui_text_set(text_display_dn, text, GUI_FONT_SOURCE_BMP, gui_rgb(UINT8_MAX, UINT8_MAX, UINT8_MAX),
