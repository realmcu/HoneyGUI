...
px_void PX_ttGetScaledFontVMetrics(px_memorypool *mp, const px_byte *fontdata, px_int index,
                                   px_float size, px_float *ascent, px_float *descent, px_float *lineGap);
typedef struct
{
...
px_int  PX_ttPackBegin(px_memorypool *mp, PX_ttpack_context *spc, px_byte *pixels, px_int width,
                       px_int height, px_int stride_in_bytes, px_int padding, px_void *alloc_context);
px_void PX_ttPackEnd(px_memorypool *mp, PX_ttpack_context *spc);

px_int  PX_ttPackFontRange(px_memorypool *mp, PX_ttpack_context *spc, const px_byte *fontdata,
                           px_int font_index, px_float font_size,
...
px_int  PX_ttPackFontRanges(px_memorypool *mp, PX_ttpack_context *spc, const px_byte *fontdata,
                            px_int font_index, PX_ttpack_range *ranges, px_int num_ranges);
px_void PX_ttPackSetOversampling(PX_ttpack_context *spc, px_uint h_oversample,
                                 px_uint v_oversample);
...
px_int  PX_ttPackFontRangesGatherRects(PX_ttpack_context *spc, const PX_ttfontinfo *info,
                                       PX_ttpack_range *ranges, px_int num_ranges, stbrp_rect *rects);
px_void PX_ttPackFontRangesPackRects(PX_ttpack_context *spc, stbrp_rect *rects, px_int num_rects);
px_int  PX_ttPackFontRangesRenderIntoRects(PX_ttpack_context *spc, const PX_ttfontinfo *info,
                                           PX_ttpack_range *ranges, px_int num_ranges, stbrp_rect *rects);
...
px_int  PX_ttGetKerningTable(const PX_ttfontinfo *info, PX_ttkerningentry *table,
                             px_int table_length);
enum
{
    STBTT_vmove = 1,
...
px_int PX_ttGetCodepointShape(const PX_ttfontinfo *info, px_int unicode_codepoint,
...
px_byte *PX_ttGetCodepointBitmap(const PX_ttfontinfo *info, px_float scale_x, px_float scale_y,
                                 px_int codepoint, px_int *width, px_int *height, px_int *xoff, px_int *yoff);
px_byte *PX_ttGetCodepointBitmapSubpixel(const PX_ttfontinfo *info, px_float scale_x,
                                         px_float scale_y, px_float shift_x, px_float shift_y, px_int codepoint, px_int *width,
                                         px_int *height, px_int *xoff, px_int *yoff);

px_void PX_ttMakeCodepointBitmapSubpixel(const PX_ttfontinfo *info, px_byte *output, px_int out_w,
                                         px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_float shift_x,
                                         px_float shift_y, px_int codepoint);
px_void PX_ttMakeCodepointBitmapSubpixelPrefilter(const PX_ttfontinfo *info, px_byte *output,
                                                  px_int out_w, px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_float shift_x,
                                                  px_float shift_y, px_int oversample_x, px_int oversample_y, px_float *sub_x, px_float *sub_y,
                                                  px_int codepoint);

px_void PX_ttGetCodepointBitmapBoxSubpixel(const PX_ttfontinfo *font, px_int codepoint,
                                           px_float scale_x, px_float scale_y, px_float shift_x, px_float shift_y, px_int *ix0, px_int *iy0,
                                           px_int *ix1, px_int *iy1);
px_byte *PX_ttGetGlyphBitmap(const PX_ttfontinfo *info, px_float scale_x, px_float scale_y,
                             px_int glyph, px_int *width, px_int *height, px_int *xoff, px_int *yoff);
px_byte *PX_ttGetGlyphBitmapSubpixel(const PX_ttfontinfo *info, px_float scale_x, px_float scale_y,
                                     px_float shift_x, px_float shift_y, px_int glyph, px_int *width, px_int *height, px_int *xoff,
                                     px_int *yoff);
px_void PX_ttMakeGlyphBitmap(const PX_ttfontinfo *info, px_byte *output, px_int out_w, px_int out_h,
                             px_int out_stride, px_float scale_x, px_float scale_y, px_int glyph);
px_void PX_ttMakeGlyphBitmapSubpixel(const PX_ttfontinfo *info, px_byte *output, px_int out_w,
                                     px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_float shift_x,
                                     px_float shift_y, px_int glyph);
px_void PX_ttMakeGlyphBitmapSubpixelPrefilter(const PX_ttfontinfo *info, px_byte *output,
                                              px_int out_w, px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_float shift_x,
                                              px_float shift_y, px_int oversample_x, px_int oversample_y, px_float *sub_x, px_float *sub_y,
                                              px_int glyph);
px_void PX_ttGetGlyphBitmapBox(const PX_ttfontinfo *font, px_int glyph, px_float scale_x,
                               px_float scale_y, px_int *ix0, px_int *iy0, px_int *ix1, px_int *iy1);
px_void PX_ttGetGlyphBitmapBoxSubpixel(const PX_ttfontinfo *font, px_int glyph, px_float scale_x,
                                       px_float scale_y, px_float shift_x, px_float shift_y, px_int *ix0, px_int *iy0, px_int *ix1,
                                       px_int *iy1);
typedef struct
{
    px_int w, h, stride;
...
px_byte *PX_ttGetGlyphSDF(const PX_ttfontinfo *info, px_float scale, px_int glyph, px_int padding,
                          px_byte onedge_value, px_float pixel_dist_scale, px_int *width, px_int *height, px_int *xoff,
                          px_int *yoff);
px_byte *PX_ttGetCodepointSDF(const PX_ttfontinfo *info, px_float scale, px_int codepoint,
                              px_int padding, px_byte onedge_value, px_float pixel_dist_scale, px_int *width, px_int *height,
                              px_int *xoff, px_int *yoff);
...
const char *PX_ttGetFontNameString(const PX_ttfontinfo *font, px_int *length, px_int platformID,
                                   px_int encodingID, px_int languageID, px_int nameID);
enum
{
...
typedef px_int PX_tt_test_oversample_pow2[(STBTT_MAX_OVERSAMPLE & (STBTT_MAX_OVERSAMPLE - 1)) == 0 ?
                                                                                              1 : -1];
...
px_int PX_ttInitFont_internal(px_memorypool *mp, PX_ttfontinfo *info, px_byte *data,
                              px_int fontstart)
{
    px_uint cmap, t;
...
px_int PX_ttFindGlyphIndex(const PX_ttfontinfo *info, px_int unicode_codepoint)
{
    ...
    else if (format == 4)
    {
        ...
        search += 2;
        {
            ...
            if (offset == 0)
            {
                return (px_ushort)(unicode_codepoint + ttSHORT(data + index_map + 14 + segcount * 4 + 2 + 2 *
                                                               item));
            }
...
px_void PX_ttsetvertex(PX_ttvertex *v, px_byte type, px_int32 x, px_int32 y, px_int32 cx,
                       px_int32 cy)
{
    v->type = type;
    v->x = (px_short) x;
...
px_int PX_tt_GetGlyphInfoT2(const PX_ttfontinfo *info, px_int glyph_index, px_int *x0, px_int *y0,
                            px_int *x1, px_int *y1);
px_int PX_ttGetGlyphBox(const PX_ttfontinfo *info, px_int glyph_index, px_int *x0, px_int *y0,
                        px_int *x1, px_int *y1)
{
    if (info->cff.size)
    {
...
px_int PX_ttGetCodepointBox(const PX_ttfontinfo *info, px_int codepoint, px_int *x0, px_int *y0,
                            px_int *x1, px_int *y1)
{
...
px_int PX_tt_close_shape(PX_ttvertex *vertices, px_int num_vertices, px_int was_off,
                         px_int start_off,
    ...
    if (numberOfContours > 0)
    {
        ...
        for (i = 0; i < n; ++i)
        {
            ...
            if (next_move == i)
            {
                if (i != 0)
                {
                    num_vertices = PX_tt_close_shape(vertices, num_vertices, was_off, start_off, sx, sy, scx, scy, cx,
                                                     cy);
                }
...
px_void PX_tt_csctx_v(PX_tt_csctx *c, px_byte type, px_int32 x, px_int32 y, px_int32 cx,
                      px_int32 cy, px_int32 cx1, px_int32 cy1)
{
    if (c->bounds)
    {
...
px_void PX_tt_csctx_rccurve_to(PX_tt_csctx *ctx, px_float dx1, px_float dy1, px_float dx2,
                               px_float dy2, px_float dx3, px_float dy3)
{
    ...
    ctx->x = cx2 + dx3;
    ctx->y = cy2 + dy3;
    PX_tt_csctx_v(ctx, STBTT_vcubic, (px_int)ctx->x, (px_int)ctx->y, (px_int)cx1, (px_int)cy1,
                  (px_int)cx2, (px_int)cy2);
}
...
px_void PX_ttGetGlyphHMetrics(const PX_ttfontinfo *info, px_int glyph_index, px_int *advanceWidth,
                              px_int *leftSideBearing)
{
...
px_int  PX_ttGetCodepointKernAdvance(const PX_ttfontinfo *info, px_int ch1, px_int ch2)
{
    ...
    return PX_ttGetGlyphKernAdvance(info, PX_ttFindGlyphIndex(info, ch1), PX_ttFindGlyphIndex(info,
                                    ch2));
}
px_void PX_ttGetCodepointHMetrics(const PX_ttfontinfo *info, px_int codepoint, px_int *advanceWidth,
                                  px_int *leftSideBearing)
{
    PX_ttGetGlyphHMetrics(info, PX_ttFindGlyphIndex(info, codepoint), advanceWidth, leftSideBearing);
}
px_void PX_ttGetFontVMetrics(const PX_ttfontinfo *info, px_int *ascent, px_int *descent,
                             px_int *lineGap)
{
...
px_int  PX_ttGetFontVMetricsOS2(const PX_ttfontinfo *info, px_int *typoAscent, px_int *typoDescent,
                                px_int *typoLineGap)
{
...
px_void PX_ttGetFontBoundingBox(const PX_ttfontinfo *info, px_int *x0, px_int *y0, px_int *x1,
                                px_int *y1)
{
...
px_void PX_ttGetCodepointBitmapBoxSubpixel(const PX_ttfontinfo *font, px_int codepoint,
                                           ...
                                           px_int *ix1, px_int *iy1)
{
    PX_ttGetGlyphBitmapBoxSubpixel(font, PX_ttFindGlyphIndex(font, codepoint), scale_x, scale_y,
                                   shift_x, shift_y, ix0, iy0, ix1, iy1);
}
px_void PX_ttGetCodepointBitmapBox(const PX_ttfontinfo *font, px_int codepoint, px_float scale_x,
                                   px_float scale_y, px_int *ix0, px_int *iy0, px_int *ix1, px_int *iy1)
{
    PX_ttGetCodepointBitmapBoxSubpixel(font, codepoint, scale_x, scale_y, 0.0f, 0.0f, ix0, iy0, ix1,
                                       iy1);
}
...
PX_tt_active_edge *PX_tt_new_active(px_memorypool *mp, PX_tt_hheap *hh, PX_tt_edge *e, px_int off_x,
                                    px_float start_point, px_void *userdata)
{
...
px_void PX_tt_handle_clipped_edge(px_float *scanline, px_int x, PX_tt_active_edge *e, px_float x0,
                                  px_float y0, px_float x1, px_float y1)
{
    if (y0 == y1) { return; }
    STBTT_assert(y0 < y1);
...
px_float PX_tt_position_trapezoid_area(px_float height, px_float tx0, px_float tx1, px_float bx0,
                                       px_float bx1)
{
...
px_void PX_tt_fill_active_edges_new(px_float *scanline, px_float *scanline_fill, px_int len,
                                    PX_tt_active_edge *e, px_float y_top)
{
        ...
        else
        {
            ...
            if (x_top >= 0 && x_bottom >= 0 && x_top < len && x_bottom < len)
            {
                ...
                else
                {
                    ...
                    scanline[x2] += area + sign * PX_tt_position_trapezoid_area(sy1 - y_final, (px_float) x2, x2 + 1.0f,
                                                                                x_bottom, x2 + 1.0f);
...
px_void PX_tt_rasterize_sorted_edges(px_memorypool *mp, PX_tt_bitmap *result, PX_tt_edge *e,
                                     px_int n, px_int vsubsample, px_int off_x, px_int off_y, px_void *userdata)
{
...
px_void PX_tt_rasterize(px_memorypool *mp, PX_tt_bitmap *result, PX_tt_point *pts, px_int *wcount,
                        px_int windings, px_float scale_x, px_float scale_y, px_float shift_x, px_float shift_y,
                        px_int off_x, px_int off_y, px_int invert, px_void *userdata)
{
...
px_int PX_tt_tesselate_curve(PX_tt_point *points, px_int *num_points, px_float x0, px_float y0,
                             px_float x1, px_float y1, px_float x2, px_float y2, px_float objspace_flatness_squared, px_int n)
{
    ...
    {
        PX_tt_tesselate_curve(points, num_points, x0, y0, (x0 + x1) / 2.0f, (y0 + y1) / 2.0f, mx, my,
                              objspace_flatness_squared, n + 1);
        PX_tt_tesselate_curve(points, num_points, mx, my, (x1 + x2) / 2.0f, (y1 + y2) / 2.0f, x2, y2,
                              objspace_flatness_squared, n + 1);
    }
    else
    {
...
px_void PX_tt_tesselate_cubic(PX_tt_point *points, px_int *num_points, px_float x0, px_float y0,
                              px_float x1, px_float y1, px_float x2, px_float y2, px_float x3, px_float y3,
                              px_float objspace_flatness_squared, px_int n)
{
    ...
    px_float dx = x3 - x0;
    px_float dy = y3 - y0;
    px_float longlen = (px_float)(STBTT_sqrt(dx0 * dx0 + dy0 * dy0) + STBTT_sqrt(
                                      dx1 * dx1 + dy1 * dy1) + STBTT_sqrt(dx2 * dx2 + dy2 * dy2));
    ...
    if (flatness_squared > objspace_flatness_squared)
    {
        ...
        px_float mx = (xa + xb) / 2;
        px_float my = (ya + yb) / 2;
        PX_tt_tesselate_cubic(points, num_points, x0, y0, x01, y01, xa, ya, mx, my,
                              objspace_flatness_squared, n + 1);
        PX_tt_tesselate_cubic(points, num_points, mx, my, xb, yb, x23, y23, x3, y3,
                              objspace_flatness_squared, n + 1);
    }
    else
    {
...
PX_tt_point *PX_ttFlattenCurves(px_memorypool *mp, PX_ttvertex *vertices, px_int num_verts,
                                px_float objspace_flatness, px_int **contour_lengths, px_int *num_contours, px_void *userdata)
{
...
px_void PX_ttRasterize(px_memorypool *mp, PX_tt_bitmap *result, px_float flatness_in_pixels,
                       PX_ttvertex *vertices, px_int num_verts, px_float scale_x, px_float scale_y, px_float shift_x,
                       px_float shift_y, px_int x_off, px_int y_off, px_int invert, px_void *userdata)
{
    px_float scale            = scale_x > scale_y ? scale_y : scale_x;
    px_int winding_count      = 0;
    px_int *winding_lengths   = PX_NULL;
    PX_tt_point *windings = PX_ttFlattenCurves(mp, vertices, num_verts, flatness_in_pixels / scale,
                                               &winding_lengths, &winding_count, userdata);
    if (windings)
    {
        PX_tt_rasterize(mp, result, windings, winding_lengths, winding_count, scale_x, scale_y, shift_x,
                                     ...
                                     px_int *yoff)
{
    ...
    PX_ttGetGlyphBitmapBoxSubpixel(info, glyph, scale_x, scale_y, shift_x, shift_y, &ix0, &iy0, &ix1,
                                   &iy1);
    ...
    if (gbm.w && gbm.h)
    {
        ...
        {
            gbm.stride = gbm.w;
            PX_ttRasterize(info->mp, &gbm, 0.35f, vertices, num_verts, scale_x, scale_y, shift_x, shift_y, ix0,
                           iy0, 1, info->userdata);
        }
    }
    MP_Free(info->mp, vertices);
...
px_byte *PX_ttGetGlyphBitmap(const PX_ttfontinfo *info, px_float scale_x, px_float scale_y,
                             px_int glyph, px_int *width, px_int *height, px_int *xoff, px_int *yoff)
{
    return PX_ttGetGlyphBitmapSubpixel(info, scale_x, scale_y, 0.0f, 0.0f, glyph, width, height, xoff,
                                       yoff);
}
px_void PX_ttMakeGlyphBitmapSubpixel(const PX_ttfontinfo *info, px_byte *output, px_int out_w,
                                     px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_float shift_x,
...
px_void PX_ttMakeGlyphBitmap(const PX_ttfontinfo *info, px_byte *output, px_int out_w, px_int out_h,
                             px_int out_stride, px_float scale_x, px_float scale_y, px_int glyph)
{
    PX_ttMakeGlyphBitmapSubpixel(info, output, out_w, out_h, out_stride, scale_x, scale_y, 0.0f, 0.0f,
                                 glyph);
}
px_byte *PX_ttGetCodepointBitmapSubpixel(const PX_ttfontinfo *info, px_float scale_x,
                                         px_float scale_y, px_float shift_x, px_float shift_y, px_int codepoint, px_int *width,
                                         px_int *height, px_int *xoff, px_int *yoff)
{
    return PX_ttGetGlyphBitmapSubpixel(info, scale_x, scale_y, shift_x, shift_y,
                                       PX_ttFindGlyphIndex(info, codepoint), width, height, xoff, yoff);
}
px_void PX_ttMakeCodepointBitmapSubpixelPrefilter(const PX_ttfontinfo *info, px_byte *output,
                                                  px_int out_w, px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_float shift_x,
                                                  px_float shift_y, px_int oversample_x, px_int oversample_y, px_float *sub_x, px_float *sub_y,
                                                  px_int codepoint)
{
    PX_ttMakeGlyphBitmapSubpixelPrefilter(info, output, out_w, out_h, out_stride, scale_x, scale_y,
                                          shift_x, shift_y, oversample_x, oversample_y, sub_x, sub_y, PX_ttFindGlyphIndex(info, codepoint));
}
px_void PX_ttMakeCodepointBitmapSubpixel(const PX_ttfontinfo *info, px_byte *output, px_int out_w,
                                         px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_float shift_x,
                                         px_float shift_y, px_int codepoint)
{
    PX_ttMakeGlyphBitmapSubpixel(info, output, out_w, out_h, out_stride, scale_x, scale_y, shift_x,
                                 shift_y, PX_ttFindGlyphIndex(info, codepoint));
}
px_byte *PX_ttGetCodepointBitmap(const PX_ttfontinfo *info, px_float scale_x, px_float scale_y,
                                 px_int codepoint, px_int *width, px_int *height, px_int *xoff, px_int *yoff)
{
    return PX_ttGetCodepointBitmapSubpixel(info, scale_x, scale_y, 0.0f, 0.0f, codepoint, width, height,
                                           xoff, yoff);
}
px_void PX_ttMakeCodepointBitmap(const PX_ttfontinfo *info, px_byte *output, px_int out_w,
                                 px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_int codepoint)
{
    PX_ttMakeCodepointBitmapSubpixel(info, output, out_w, out_h, out_stride, scale_x, scale_y, 0.0f,
                                     0.0f, codepoint);
}
...
px_void PX_ttGetBakedQuad(const PX_ttbakedchar *chardata, px_int pw, px_int ph, px_int char_index,
                          px_float *xpos, px_float *ypos, PX_ttaligned_quad *q, px_int opengl_fillrule)
{
...
px_void stbrp_init_target(stbrp_context *con, px_int pw, px_int ph, stbrp_node *nodes,
                          px_int num_nodes)
{
    con->width  = pw;
    con->height = ph;
...
#endif
px_int PX_ttPackBegin(px_memorypool *mp, PX_ttpack_context *spc, px_byte *pixels, px_int pw,
                      px_int ph, px_int stride_in_bytes, px_int padding, px_void *alloc_context)
{
...
px_void PX_tt_h_prefilter(px_byte *pixels, px_int w, px_int h, px_int stride_in_bytes,
                          px_uint kernel_width)
{
...
px_void PX_tt_v_prefilter(px_byte *pixels, px_int w, px_int h, px_int stride_in_bytes,
                          px_uint kernel_width)
{
    px_byte buffer[STBTT_MAX_OVERSAMPLE];
                                      ...
                                      PX_ttpack_range *ranges, px_int num_ranges, stbrp_rect *rects)
{
    ...
    for (i = 0; i < num_ranges; ++i)
    {
        ...
        px_float scale = fh > 0 ? PX_ttScaleForPixelHeight(info, fh) : PX_ttScaleForMappingEmToPixels(info,
                         -fh);
        ...
        {
            px_int x0, y0, x1, y1;
            px_int codepoint = ranges[i].array_of_unicode_codepoints == PX_NULL ?
...
px_void PX_ttMakeGlyphBitmapSubpixelPrefilter(const PX_ttfontinfo *info, px_byte *output,
                                              px_int out_w, px_int out_h, px_int out_stride, px_float scale_x, px_float scale_y, px_float shift_x,
                                              px_float shift_y, px_int prefilter_x, px_int prefilter_y, px_float *sub_x, px_float *sub_y,
                                              px_int glyph)
{
...
px_int PX_ttPackFontRange(px_memorypool *mp, PX_ttpack_context *spc, const px_byte *fontdata,
                          px_int font_index, px_float font_size,
                          px_int first_unicode_codepoint_in_range, px_int num_chars_in_range,
                          PX_ttpackedchar *chardata_for_range)
{
                                   ...
                                   px_float size, px_float *ascent, px_float *descent, px_float *lineGap)
{
    ...
    scale = size > 0 ? PX_ttScaleForPixelHeight(&info, size) : PX_ttScaleForMappingEmToPixels(&info,
            -size);
...
px_void PX_ttGetPackedQuad(const PX_ttpackedchar *chardata, px_int pw, px_int ph, px_int char_index,
                           px_float *xpos, px_float *ypos, PX_ttaligned_quad *q, px_int align_to_integer)
{
    px_float ipw = 1.0f / pw, iph = 1.0f / ph;
...
px_int PX_tt_ray_intersect_bezier(px_float orig[2], px_float ray[2], px_float q0[2], px_float q1[2],
                                  px_float q2[2], px_float hits[2][2])
{
...
px_byte *PX_ttGetCodepointSDF(const PX_ttfontinfo *info, px_float scale, px_int codepoint,
                              ...
                              px_int *xoff, px_int *yoff)
{
    return PX_ttGetGlyphSDF(info, scale, PX_ttFindGlyphIndex(info, codepoint), padding, onedge_value,
...
px_int32 PX_tt_CompareUTF8toUTF16_bigendian_prefix(px_byte *s1, px_int32 len1, px_byte *s2,
                                                   px_int32 len2)
{
    px_int32 i = 0;
...
{
    return len1 == PX_tt_CompareUTF8toUTF16_bigendian_prefix((px_byte *) s1, len1, (px_byte *) s2,
                                                             len2);
}
const char *PX_ttGetFontNameString(const PX_ttfontinfo *font, px_int *length, px_int platformID,
                                   px_int encodingID, px_int languageID, px_int nameID)
...
px_int PX_tt_matchpair(px_byte *fc, px_uint nm, px_byte *name, px_int32 nlen, px_int32 target_id,
                       px_int32 next_id)
{
    px_int32 i;
    ...
    for (i = 0; i < count; ++i)
    {
        ...
        if (id == target_id)
        {
            ...
            px_int32 platform = ttUSHORT(fc + loc + 0), encoding = ttUSHORT(fc + loc + 2),
            ...
            if (platform == 0 || (platform == 3 && encoding == 1) || (platform == 3 && encoding == 10))
            {
                ...
                px_int32 matchlen = PX_tt_CompareUTF8toUTF16_bigendian_prefix(name, nlen, fc + stringOffset + off,
                                                                              slen);
                if (matchlen >= 0)
                {
                        ...
                        ttUSHORT(fc + loc + 12 + 4) == language)
                    {
                        ...
                        {
                            ++matchlen;
                            if (PX_ttCompareUTF8toUTF16_bigendian_internal((char *)(name + matchlen), nlen - matchlen,
...
{
    return PX_ttBakeFontBitmap_internal(mp, (px_byte *) data, offset, pixel_height, pixels, pw, ph,
