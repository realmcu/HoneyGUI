...
px_double PX_atan(px_double x)
{
    if (x < 0)
        ...
        else if (x < (px_double)(1.353860343122586362e-8))
        {
            return atani0(x);
        }
        else if (x <= (px_double)(2.225073858507201383e-308))
...
px_int PX_sprintf8(px_char *_out_str, px_int str_size, const px_char fmt[], px_stringformat _1,
                   px_stringformat _2, px_stringformat _3, px_stringformat _4, px_stringformat _5, px_stringformat _6,
...
px_int PX_sprintf7(px_char *str, px_int str_size, const px_char fmt[], px_stringformat _1,
                   px_stringformat _2, px_stringformat _3, px_stringformat _4, px_stringformat _5, px_stringformat _6,
                   px_stringformat _7)
{
...
px_int PX_sprintf6(px_char *str, px_int str_size, const px_char fmt[], px_stringformat _1,
                   px_stringformat _2, px_stringformat _3, px_stringformat _4, px_stringformat _5, px_stringformat _6)
{
    return PX_sprintf8(str, str_size, fmt, _1, _2, _3, _4, _5, _6, PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0));
}


px_int PX_sprintf5(px_char *str, px_int str_size, const px_char fmt[], px_stringformat _1,
                   px_stringformat _2, px_stringformat _3, px_stringformat _4, px_stringformat _5)
{
    return PX_sprintf8(str, str_size, fmt, _1, _2, _3, _4, _5, PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0));
}


px_int PX_sprintf4(px_char *str, px_int str_size, const px_char fmt[], px_stringformat _1,
                   px_stringformat _2, px_stringformat _3, px_stringformat _4)
{
    return PX_sprintf8(str, str_size, fmt, _1, _2, _3, _4, PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0));
}


px_int PX_sprintf3(px_char *str, px_int str_size, const px_char fmt[], px_stringformat _1,
                   px_stringformat _2, px_stringformat _3)
{
    return PX_sprintf8(str, str_size, fmt, _1, _2, _3, PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0));
}


px_int PX_sprintf2(px_char *str, px_int str_size, const px_char fmt[], px_stringformat _1,
                   px_stringformat _2)
{
    return PX_sprintf8(str, str_size, fmt, _1, _2, PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0));
}


px_int PX_sprintf1(px_char *str, px_int str_size, const px_char fmt[], px_stringformat _1)
{
    return PX_sprintf8(str, str_size, fmt, _1, PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0));
}
...
{
    return PX_sprintf8(str, str_size, fmt, PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
                       PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0));
}
...
{
    px_matrix ptmat;
    ptmat._11 = Mat1._11 + Mat2._11; ptmat._12 = Mat1._12 + Mat2._12; ptmat._13 = Mat1._13 + Mat2._13;
    ptmat._14 = Mat1._14 + Mat2._14;
    ptmat._21 = Mat1._21 + Mat2._21; ptmat._22 = Mat1._22 + Mat2._22; ptmat._23 = Mat1._23 + Mat2._23;
    ptmat._24 = Mat1._24 + Mat2._24;
    ptmat._31 = Mat1._31 + Mat2._31; ptmat._32 = Mat1._32 + Mat2._32; ptmat._33 = Mat1._33 + Mat2._33;
    ptmat._34 = Mat1._34 + Mat2._34;
    ptmat._41 = Mat1._41 + Mat2._41; ptmat._42 = Mat1._42 + Mat2._42; ptmat._43 = Mat1._43 + Mat2._43;
    ptmat._44 = Mat1._44 + Mat2._44;
    return ptmat;
}
...
px_void PX_MatrixRotateX(px_matrix *mat, px_float Angle)
{
    ...
    mat->_14 = 0.0f;
    mat->_21 = 0.0f;                      mat->_22 = PX_cos_angle(Angle);
    mat->_23 = PX_sin_angle(Angle);               mat->_24 = 0.0f;
    mat->_31 = 0.0f;                      mat->_32 = -PX_sin_angle(Angle);
    mat->_33 = PX_cos_angle(Angle);               mat->_34 = 0.0f;
...
{
    mat->_11 = PX_cos_angle(Angle);       mat->_12 = 0.0f;
    mat->_13 = PX_sin_angle(Angle);           mat->_14 = 0.0f;
    mat->_21 = 0.0f;                      mat->_22 = 1.0f;                          mat->_23 = 0.0f;
    mat->_24 = 0.0f;
    mat->_31 = -PX_sin_angle(Angle);      mat->_32 = 0.0f;
    mat->_33 = PX_cos_angle(Angle);           mat->_34 = 0.0f;
    mat->_41 = 0.0f;                      mat->_42 = 0.0f;                          mat->_43 = 0.0f;
    mat->_44 = 1.0f;
}
...
px_void PX_MatrixRotateZ(px_matrix *mat, px_float Angle)
{
    ...
    mat->_11 = PX_cos_angle(Angle);       mat->_12 = PX_sin_angle(Angle);           mat->_13 = 0.0f;
    mat->_14 = 0.0f;
    mat->_21 = -PX_sin_angle(Angle);      mat->_22 = PX_cos_angle(Angle);           mat->_23 = 0.0f;
    mat->_24 = 0.0f;
...
px_void PX_MatrixRotateXRadian(px_matrix *mat, px_float rad)
{
    mat->_11 = 1.0f;                      mat->_12 = 0;                             mat->_13 = 0.0f;
    mat->_14 = 0.0f;
    mat->_21 = 0.0f;                      mat->_22 = PX_cos_radian(rad);
    mat->_23 = PX_sin_radian(rad);                mat->_24 = 0.0f;
    mat->_31 = 0.0f;                      mat->_32 = -PX_sin_radian(rad);
    mat->_33 = PX_cos_radian(rad);                mat->_34 = 0.0f;
    mat->_41 = 0.0f;                      mat->_42 = 0.0f;                          mat->_43 = 0.0f;
    mat->_44 = 1.0f;
}
...
{
    mat->_11 = PX_cos_radian(rad);        mat->_12 = 0.0f;
    mat->_13 = PX_sin_radian(rad);            mat->_14 = 0.0f;
    mat->_21 = 0.0f;                      mat->_22 = 1.0f;                          mat->_23 = 0.0f;
    mat->_24 = 0.0f;
    mat->_31 = -PX_sin_radian(rad);       mat->_32 = 0.0f;
    mat->_33 = PX_cos_radian(rad);            mat->_34 = 0.0f;
    mat->_41 = 0.0f;                      mat->_42 = 0.0f;                          mat->_43 = 0.0f;
    mat->_44 = 1.0f;
}
...
px_void PX_MatrixRotateZRadian(px_matrix *mat, px_float rad)
{
    ...
    mat->_11 = PX_cos_radian(rad);        mat->_12 = PX_sin_radian(rad);            mat->_13 = 0.0f;
    mat->_14 = 0.0f;
    mat->_21 = -PX_sin_radian(rad);       mat->_22 = PX_cos_radian(rad);            mat->_23 = 0.0f;
    mat->_24 = 0.0f;
    mat->_31 = 0.0f;                      mat->_32 = 0.0f;                          mat->_33 = 1.0f;
    mat->_34 = 0.0f;
    mat->_41 = 0.0f;                      mat->_42 = 0.0f;                          mat->_43 = 0.0f;
...
px_color PX_ColorHSLToRGB(px_color_hsl color_hsl)
{
    ...
    return PX_COLOR((px_uchar)(color_hsl.a * 255), (px_uchar)(r * 255), (px_uchar)(g * 255),
                    (px_uchar)(b * 255));
}
...
px_bool PX_isXYInRegion(px_float x, px_float y, px_float rectx, px_float recty, px_float width,
                        px_float height)
{
    if (x < rectx)
    {
...
px_float PX_PitchEstimation(_IN px_complex x[], px_int N, px_int sampleRate, px_int low_Hz,
                            px_int high_Hz)
{
...
px_void PX_PreEmphasise(const px_double *data, px_int len, px_double *out,
                        px_double preF)//0.9<preF<1.0 suggest 0.9
{
    px_int i;
    for (i = len - 1; i >= 1; i--)
    {
...
px_bool PX_strIsNumeric(const px_char *str)
{
         ...
         CurrentCharIndex++)
    {
        ...
        {
            if (str[CurrentCharIndex] == 'e' && (str[CurrentCharIndex + 1] == '+' ||
                                                 str[CurrentCharIndex + 1] == '-'))
            {
                CurrentCharIndex++;
                continue;
            }
...
px_void PX_gain(px_double b[], px_double a[], px_int m, px_int n, px_double x[], px_double y[],
                px_int len, px_int sign)
{
    px_int i, k;
...
px_void PX_gainc(px_double b[], px_double a[], px_int n, px_int ns, px_double x[], px_double y[],
                 px_int len, px_int sign)
{
    px_int i, j, k, nl;
    px_double ar, ai, br, bi, zr, zi, im, re, den, numr, numi, freq, temp;
...
px_void  PX_WindowFunction_blackMan(px_double data[], px_int N)
{
    ...
    for (n = 0; n < N; n++)
    {
        data[n] = 0.42 - 0.5 * PX_cosd((px_float)(2 * PX_PI * (px_double)n / (N - 1)) + 0.08f *
                                       PX_cos_radian((px_float)(4 * PX_PI * (px_double)n / (N - 1))));
    }
}
...
px_void   PX_WindowFunction_kaiser(px_double beta, px_double data[], px_int N)
{
    ...
    for (n = 0; n < N; n++)
    {
        theta = beta * PX_sqrtd(1 - ((2 * (px_double)n / (N - 1)) - 1) * ((2 * (px_double)n /
                                                                           (N - 1)) - 1));
...
static px_double PX_FIRWindow(PX_FIRFILTER_WINDOW_TYPE type, px_int n, px_int i, px_double beta)
{
    ...
    case PX_FIRFILTER_WINDOW_TYPE_BLACKMAN:
        {
            w = 0.42 - 0.5 * PX_cos_radian((px_float)(2.0f * i * pi / (n - 1.0f))) + 0.08 * PX_cos_radian((
                        px_float)(4.0f * i * pi / (n - 1.0f)));
            break;
        }
...
px_void PX_FIRFilterBuild(PX_FIRFILTER_TYPE bandtype, px_double fln, px_double fhn,
                          PX_FIRFILTER_WINDOW_TYPE wn, px_double h[], px_int n, px_double beta)
{
    px_int i, n2, mid;
...
px_double PX_GroupDelay(px_double f, px_double *B, px_int sizeB, px_double *A, px_int sizeA,
                        px_double FS)
{
    px_int i;
    px_double omega;
...
static px_double PX_PhaseIIR(px_double omega, px_double *B, px_int sizeB, px_double *A,
                             px_int sizeA)
{
    px_double C[2];
    px_double HB[2] = { 0 };
...
px_double PX_PhaseDelayDerive(px_double omega, px_double *B, px_int sizeB, px_double *A,
                              px_int sizeA, px_double delta)
{
...
px_double PX_PhaseDelay(px_double f, px_double *B, px_int sizeB, px_double *A, px_int sizeA,
                        px_double FS)
{
...
px_void PX_SoundResamplerInitialize(PX_SoundResampler *pResampler, px_double in_sample_rate,
