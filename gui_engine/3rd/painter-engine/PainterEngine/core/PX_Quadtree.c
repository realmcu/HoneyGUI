...
static px_bool PX_Quadtree_InitAABB(px_memorypool *mp, px_int PX_AABB_MAX_DEEP,
...
px_bool PX_QuadtreeCreate(px_memorypool *mp, PX_Quadtree *pQuadtree, px_float mapStartX,
                          px_float mapStartY, px_float mapWidth, px_float mapHeight, px_int ObjectsCount, px_int deep)
{
...
static px_void PX_QuadtreeTest(PX_Quadtree *pQuadtree, PX_Quadtree_AABB *aabb,
                               PX_Quadtree_AABB_BOX testBox)
{
...
static px_void PX_QuadtreeTestBox(PX_Quadtree *pQuadtree, PX_Quadtree_AABB *aabb,
...
px_void PX_QuadtreeAddNode(PX_Quadtree *pQuadtree, px_float x, px_float y, px_float width,
                           px_float height, PX_Quadtree_UserData userData)
{
    PX_Quadtree_AABB_BOX box;
    box.height = height;
    box.width = width;
...
px_void PX_QuadtreeTestNode(PX_Quadtree *pQuadtree, px_float x, px_float y, px_float width,
                            px_float height, PX_Quadtree_UserData userData)
{
    PX_Quadtree_AABB_BOX box;
    box.height = height;
