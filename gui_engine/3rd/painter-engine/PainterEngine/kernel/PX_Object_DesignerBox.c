...
PX_Object *PX_Object_DesignerBoxCreate(px_memorypool *mp, PX_Object *Parent, px_float x, px_float y,
                                       px_float widht, px_float height)
{
    ...
    pObject = PX_ObjectCreateEx(mp, Parent, x, y, 0, widht, height, 0, PX_OBJECT_TYPE_DESIGNERBOX,
                                PX_NULL, PX_Object_DesignerBoxRender, PX_NULL, &desc, sizeof(desc));
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORDOWN, PX_Object_DesignerBoxOnCursorDown,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORDRAG, PX_Object_DesignerBoxOnCursorDrag,
                           PX_NULL);
    return pObject;
...
px_void PX_Object_DesignerBoxReset(PX_Object *pObject, px_float x, px_float y, px_float width,
                                   px_float height)
{
    PX_Object_DesignerBox *pDesc = PX_ObjectGetDesc(PX_Object_DesignerBox, pObject);
    pObject->x = x;
