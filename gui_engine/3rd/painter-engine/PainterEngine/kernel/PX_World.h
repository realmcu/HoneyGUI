...
typedef PX_Object *(*PX_WorldCreateObjectFunc)(PX_World *pWorld, px_float x, px_float y, px_float z,
                                               px_float width, px_float height, px_float length, px_abi *abi);
...
typedef PX_Object *(*px_world_func_CreateObject)(PX_World *pWorld, px_float x, px_float y,
                                                 px_float z, px_float width, px_float height, px_float length, px_void *user, px_abi *abi);
typedef struct
{
    const px_char *name;
...
_LIMIT px_int   PX_WorldSearchRegion(PX_World *pWorld, px_float centerX, px_float centerY,
                                     px_float raduis, PX_Object *pObject[], px_int MaxSearchCount, px_dword impact_test_type);
_LIMIT px_int   PX_WorldSearch(PX_World *world, PX_Object *pObject[], px_int MaxSearchCount,
