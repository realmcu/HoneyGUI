...
typedef px_void(*pfun_PX_CanvasVMOnPaint)(px_surface *psurface, px_float x, px_float y,
                                          px_float size, px_color color, px_void *ptr);
...
typedef struct _PX_CanvasVM
{
    ...
    px_texture cache_surface, cache_backward_surface, *pcache_editing_surface, cache_frontward_surface,
               *pcache_mask_surface;
