...
PX_Object *PX_Object_VarBoxCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y,
                                  px_int width, px_int height, const px_char title[], PX_FontModule *fontmodule)
{
    ...
    pObject = PX_ObjectCreateEx(mp, Parent, (px_float)x, (px_float)y, 0, (px_float)width,
                                (px_float)height, 0, PX_OBJECT_TYPE_VARBOX, PX_NULL, PX_NULL, PX_NULL, &desc, sizeof(desc));
    ...
    pdesc->various_size = PX_Object_VariousCreate(mp, pdesc->widget, width / 2 - 128, 112, 256, 32,
                                                  "Size:", PX_OBJECT_VARIOUS_TYPE_EDIT, fontmodule);
    ...
    PX_ObjectRegisterEvent(pdesc->selectbar_type, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_VarBoxOnTypeChanged, pdesc);
    ...
    PX_ObjectRegisterEvent(pdesc->btn_close, PX_OBJECT_EVENT_EXECUTE, PX_Object_VarBoxOnCancel,
                           pObject);
