    ...
    case PX_ALIGN_LEFTMID:
        {
            if (pImage != PX_NULL)
            {
                if (pImage->pmask)
                {
                    PX_TextureRenderMask(psurface, pImage->pmask, prenderTexture, x, y + h / 2, PX_ALIGN_LEFTMID,
                                         PX_NULL);
                }
                else
                {
    ...
    case PX_ALIGN_LEFTBOTTOM:
        {
            if (pImage != PX_NULL)
            {
                if (pImage->pmask)
                {
                    PX_TextureRenderMask(psurface, pImage->pmask, prenderTexture, x, y + h, PX_ALIGN_LEFTBOTTOM,
                                         PX_NULL);
                }
                else
                {
    ...
    case PX_ALIGN_MIDTOP:
        {
            if (pImage != PX_NULL)
            {
                if (pImage->pmask)
                {
                    PX_TextureRenderMask(psurface, pImage->pmask, prenderTexture, x + w / 2, y, PX_ALIGN_MIDTOP,
                                         PX_NULL);
                }
                else
                {
    ...
    case PX_ALIGN_CENTER:
        {
            if (pImage != PX_NULL)
            {
                if (pImage->pmask)
                {
                    PX_TextureRenderMask(psurface, pImage->pmask, prenderTexture, x + w / 2, y + h / 2, PX_ALIGN_CENTER,
                                         PX_NULL);
                }
                else
                {
    ...
    case PX_ALIGN_MIDBOTTOM:
        {
            if (pImage != PX_NULL)
            {
                if (pImage->pmask)
                {
                    PX_TextureRenderMask(psurface, pImage->pmask, prenderTexture, x + w / 2, y + h, PX_ALIGN_MIDBOTTOM,
                                         PX_NULL);
                }
                else
                {
    ...
    case PX_ALIGN_RIGHTTOP:
        {
            if (pImage != PX_NULL)
            {
                if (pImage->pmask)
                {
                    PX_TextureRenderMask(psurface, pImage->pmask, prenderTexture, x + w, y, PX_ALIGN_RIGHTTOP,
                                         PX_NULL);
                }
                else
                {
    ...
    case PX_ALIGN_RIGHTMID:
        {
            if (pImage != PX_NULL)
            {
                if (pImage->pmask)
                {
                    PX_TextureRenderMask(psurface, pImage->pmask, prenderTexture, x + w, y + h / 2, PX_ALIGN_RIGHTMID,
                                         PX_NULL);
                }
                else
                {
    ...
    case PX_ALIGN_RIGHTBOTTOM:
        {
            if (pImage != PX_NULL)
            {
                if (pImage->pmask)
                {
                    PX_TextureRenderMask(psurface, pImage->pmask, prenderTexture, x + w, y + h, PX_ALIGN_RIGHTBOTTOM,
                                         PX_NULL);
                }
                else
                {
...
PX_Object *PX_Object_ImageCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y,
                                 px_int width, px_int height, px_texture *ptex)
{
    PX_Object *pObject;
