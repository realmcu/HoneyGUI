...
px_void PX_Object_OscilloscopeSetLineMode(PX_Object *pObj, PX_OBJECT_OSCILLOSCOPE_LINEMODE mode,
                                          px_float width)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObj);
    if (!pcd)
...
px_void PX_Object_OscilloscopeSetGuidesShowMode(PX_Object *pObject,
                                                PX_OBJECT_OSCILLOSCOPE_GUIDESSHOWMODE mode)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
    if (!pcd)
    {
...
px_void PX_Object_OscilloscopeSetFloatFlagFormatVerticalRight(PX_Object *pObject,
                                                              const px_char *fmt)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
    if (!pcd)
...
px_void PX_Object_OscilloscopeSetLeftTextMode(PX_Object *pObject,
                                              PX_OBJECT_OSCILLOSCOPE_TEXT_DISPLAYMODE mode)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
    if (!pcd)
    {
...
px_void PX_Object_OscilloscopeSetRightTextMode(PX_Object *pObject,
                                               PX_OBJECT_OSCILLOSCOPE_TEXT_DISPLAYMODE mode)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
    if (!pcd)
...
px_void PX_Object_OscilloscopeSetRenderMode(PX_Object *pObject,
                                            PX_OBJECT_OSCILLOSCOPE_RENDER_MODE mode)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
    if (!pcd)
    {
...
PX_Object_OscilloscopeData *PX_Object_OscilloscopeGetOscilloscopeData(PX_Object *pObject,
                                                                      px_int index)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
...
void PX_Object_OscilloscopeAddOscilloscopeFlagLine(PX_Object *pObject,
                                                   PX_Object_OscilloscopeFlagLine Line)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
...
px_void PX_Object_OscilloscopeSetMargin(PX_Object *pObject, px_int Left, px_int Right, px_int Top,
                                        px_int Bottom)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
    pcd->LeftSpacer = Left;
...
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
    px_double scale = PX_Object_OscilloscopeGetOscilloscopeWidth(pObject) /
                      (pcd->HorizontalRangeMax - pcd->HorizontalRangeMin);
...
px_int  PX_Object_OscilloscopeMapVerticalValueToPixel(PX_Object *pObject, px_double val, px_int Map)
{
    ...
    {
        scale = PX_Object_OscilloscopeGetOscilloscopeHeight(pObject) / (pcd->LeftVerticalRangeMax -
                                                                        pcd->LeftVerticalRangeMin);
        return (px_int)(pObject->Height - pcd->BottomSpacer - (px_int)((val - pcd->LeftVerticalRangeMin) *
                                                                       scale));
    }
    else if (Map == PX_OBJECT_OSCILLOSCOPEDATA_MAP_RIGHT)
    {
        scale = PX_Object_OscilloscopeGetOscilloscopeHeight(pObject) / (pcd->RightVerticalRangeMax -
                                                                        pcd->RightVerticalRangeMin);
        return (px_int)(pObject->Height - pcd->BottomSpacer - (px_int)((val - pcd->RightVerticalRangeMin) *
                                                                       scale));
    }
...
px_double  PX_Object_OscilloscopeMapPixelValueToHorizontal(PX_Object *pObject, px_int Pixel)
{
    ...
    return pcd->HorizontalRangeMin + XDisten * (pcd->HorizontalRangeMax - pcd->HorizontalRangeMin) /
           PX_Object_OscilloscopeGetOscilloscopeWidth(pObject);

}

px_double  PX_Object_OscilloscopeMapPixelValueToVertical(PX_Object *pObject, px_int Pixel,
                                                         px_int Map)
{
    PX_Object_Oscilloscope *pcd = PX_Object_GetOscilloscope(pObject);
    px_double Min, Max;
    if (Map == PX_OBJECT_OSCILLOSCOPEDATA_MAP_LEFT)
    {
        ...
        return pcd->LeftVerticalRangeMin + (pObject->Height - pcd->BottomSpacer - Pixel) *
               (Max - Min) / PX_Object_OscilloscopeGetOscilloscopeHeight(pObject);
    }
    ...
    if (Map == PX_OBJECT_OSCILLOSCOPEDATA_MAP_RIGHT)
    {
        ...
        return pcd->RightVerticalRangeMin + (pObject->Height - pcd->BottomSpacer - Pixel) *
               (Max - Min) / PX_Object_OscilloscopeGetOscilloscopeHeight(pObject);
    }
    ...
    if (Map == PX_OBJECT_OSCILLOSCOPEDATA_MAP_HORIZONTAL)
    {
        ...
        return pcd->HorizontalRangeMin + (Pixel - pcd->LeftSpacer) * (Max - Min) /
               PX_Object_OscilloscopeGetOscilloscopeWidth(pObject);
    }
    return 0;
}
...
static px_void PX_Object_OscilloscopeDrawFrameLine(px_surface *psurface, PX_Object *pObject)
{
    ...
    PX_GeoDrawLine(psurface, offsetx + pcd->LeftSpacer, offsety + pcd->TopSpacer,
                   offsetx + (px_int)(objWidth - pcd->RightSpacer), offsety + pcd->TopSpacer,
                   PX_OBJECT_OSCILLOSCOPE_DEFAULT_FRAMELINE_WIDTH, pcd->borderColor);
    PX_GeoDrawLine(psurface, offsetx + pcd->LeftSpacer, offsety + pcd->TopSpacer,
                   offsetx + pcd->LeftSpacer, offsety + (px_int)(objHeight - pcd->BottomSpacer),
                   PX_OBJECT_OSCILLOSCOPE_DEFAULT_FRAMELINE_WIDTH, pcd->borderColor);
    PX_GeoDrawLine(psurface, (px_int)(offsetx + objWidth - pcd->RightSpacer),
                   offsety + (px_int)(objHeight - pcd->BottomSpacer), offsetx + (pcd->LeftSpacer),
                   offsety + (px_int)objHeight - pcd->BottomSpacer, PX_OBJECT_OSCILLOSCOPE_DEFAULT_FRAMELINE_WIDTH,
                   pcd->borderColor);
    PX_GeoDrawLine(psurface, (px_int)(offsetx + objWidth - pcd->RightSpacer),
                   offsety + (px_int)(objHeight - pcd->BottomSpacer), offsetx + (px_int)(objWidth - pcd->RightSpacer),
                   offsety + pcd->TopSpacer, PX_OBJECT_OSCILLOSCOPE_DEFAULT_FRAMELINE_WIDTH, pcd->borderColor);
}
...
static px_void PX_Object_OscilloscopeDrawDashed(px_surface *psurface, PX_Object *pObject)
{
    ...
    px_int Divid = PX_Object_OscilloscopeGetOscilloscopeWidth(pObject) /
                   pcd->MinHorizontalPixelDividing;
    ...
    if (Divid > 1)
    {
        ...
        if (pcd->guidesShowMode == PX_OBJECT_OSCILLOSCOPE_GUIDESSHOWMODE_ALL ||
            pcd->guidesShowMode == PX_OBJECT_OSCILLOSCOPE_GUIDESSHOWMODE_HORIZONTAL)
        {
            for (i = 1; i <= Divid; i++)
            {
                PX_GeoDrawLine(psurface, \
                               offsetx + (px_int)(pcd->LeftSpacer + i * HorizontalInc), offsety + pcd->TopSpacer, \
                               offsetx + (px_int)(pcd->LeftSpacer + i * HorizontalInc),
                               offsety + pcd->TopSpacer + PX_Object_OscilloscopeGetOscilloscopeHeight(pObject), \
                               1, \
                               pcd->DashColor
                              );
            }
    ...
    if (Divid > 1)
    {
        ...
        if (pcd->guidesShowMode == PX_OBJECT_OSCILLOSCOPE_GUIDESSHOWMODE_ALL ||
            pcd->guidesShowMode == PX_OBJECT_OSCILLOSCOPE_GUIDESSHOWMODE_VERTICAL)
        {
            for (i = 1; i <= Divid; i++)
            {
                PX_GeoDrawLine(psurface, \
...
static px_void PX_Object_OscilloscopeDrawDashText(px_surface *psurface, PX_Object *pObject)
{
    ...
    if (Divid > 0 && pcd->HorizontalTextShow)
    {
        ...
        for (i = 0; i <= Divid; i++)
        {
            ...
            if (IsFloat)
            {
                PX_sprintf1(text, sizeof(text), pcd->FloatFlagFormat_H,
                            PX_STRINGFORMAT_FLOAT((px_float)(pcd->HorizontalRangeMin + i * ValInc)));
            }
            else
            {
                PX_sprintf1(text, sizeof(text), pcd->IntFlagFormat_H,
                            PX_STRINGFORMAT_INT((px_int)(pcd->HorizontalRangeMin + i * ValInc)));
            }

            PX_FontModuleDrawText(psurface, PX_NULL, offsetx + (px_int)(pcd->LeftSpacer + (i)*HorizontalInc),
                                  offsety + (px_int)(pObject->Height - pcd->BottomSpacer +
                                                     PX_OBJECT_OSCILLOSCOPE_DEFAULT_FLAGTEXT_SPACER + 2), PX_ALIGN_CENTER, text, pcd->FontColor);
        }
    }
    ...
    if (Divid > 0)
    {
        ...
        if (pcd->LeftTextShow)
        {
            ...
            for (i = 0; i <= Divid; i++)
            {
                ...
                case PX_OBJECT_OSCILLOSCOPE_TEXT_DISPLAYMODE_EXPONENTRAL:
                    {
                        px_double value = PX_ABS(pcd->LeftVerticalRangeMin) > PX_ABS(pcd->LeftVerticalRangeMax) ? PX_ABS(
                                              pcd->LeftVerticalRangeMin) : PX_ABS(pcd->LeftVerticalRangeMax);
                        px_int e = 0;
                        px_double e10 = 1;
                        ...
                        if (e >= 3)
                        {
                            PX_sprintf2(text, sizeof(text), pcd->Exponential_Format, PX_STRINGFORMAT_FLOAT((px_float)(value)),
                                        PX_STRINGFORMAT_INT(e));
                        }
                        else
                        {
                            if (IsFloat)
                            {
                                PX_sprintf1(text, sizeof(text), pcd->FloatFlagFormat_L,
                                            PX_STRINGFORMAT_FLOAT((px_float)(pcd->LeftVerticalRangeMin + i * ValInc)));
                            }
                            else
                            {
                                PX_sprintf1(text, sizeof(text), pcd->IntFlagFormat_L,
                                            PX_STRINGFORMAT_INT((px_int)(pcd->LeftVerticalRangeMin + i * ValInc)));
                            }
                        }
                ...
                PX_FontModuleDrawText(psurface, PX_NULL, offsetx + pcd->LeftSpacer - 6,
                                      offsety + (px_int)(pObject->Height - pcd->BottomSpacer - (i)*VerticalInc - 6), PX_ALIGN_RIGHTTOP,
                                      text, pcd->FontColor);
            }
        }
        ...
        if (pcd->RightTextShow)
        {
            ...
            for (i = 0; i <= Divid; i++)
            {
                ...
                case PX_OBJECT_OSCILLOSCOPE_TEXT_DISPLAYMODE_EXPONENTRAL:
                    {
                        px_double value = PX_ABS(pcd->RightVerticalRangeMin) > PX_ABS(pcd->RightVerticalRangeMax) ? PX_ABS(
                                              pcd->RightVerticalRangeMin) : PX_ABS(pcd->RightVerticalRangeMax);
                        px_int e = 0;
                        px_double e10 = 1;
                        while (value > 10) {value /= 10, e++; e10 *= 10;};
                        ...
                        else
                        {
                            if (IsFloat)
                            {
                                PX_sprintf1(text, sizeof(text), pcd->FloatFlagFormat_R,
                                            PX_STRINGFORMAT_FLOAT((px_float)(pcd->LeftVerticalRangeMin + i * ValInc)));
                            }
                            else
                            {
                                PX_sprintf1(text, sizeof(text), pcd->IntFlagFormat_R,
                                            PX_STRINGFORMAT_INT((px_int)(pcd->LeftVerticalRangeMin + i * ValInc)));
                            }
                        }
                ...
                case PX_OBJECT_OSCILLOSCOPE_TEXT_DISPLAYMODE_NORMAL:
                    {
                        ...
                        {
                            PX_sprintf1(text, sizeof(text), pcd->FloatFlagFormat_R,
                                        PX_STRINGFORMAT_FLOAT((px_float)(pcd->RightVerticalRangeMin + i * ValInc)));
                        }
                        else
                        {
                            PX_sprintf1(text, sizeof(text), pcd->IntFlagFormat_R,
                                        PX_STRINGFORMAT_INT((px_int)(pcd->RightVerticalRangeMin + i * ValInc)));
                        }
                    }
                    break;
                }
                PX_FontModuleDrawText(psurface, PX_NULL,
                                      offsetx + (px_int)(pObject->Width - pcd->RightSpacer +
                                                         PX_OBJECT_OSCILLOSCOPE_DEFAULT_FLAGTEXT_SPACER),
                                      offsety + (px_int)(pObject->Height - pcd->BottomSpacer - (i)*VerticalInc - 6), PX_ALIGN_LEFTTOP,
                                      text, pcd->FontColor);
            }
        }
    }
...
static px_void PX_Object_OscilloscopeDrawTitle(px_surface *psurface, PX_Object *pObject)
{
    ...
    if (pcd->TopTitle[0])
    {
        PX_FontModuleDrawText(psurface, pcd->fontmodule, offsetx + (px_int)(pObject->Width / 2), offsety,
                              PX_ALIGN_MIDTOP, pcd->TopTitle, pcd->FontColor);
    }

    if (pcd->BottomTitle[0])
    {
        PX_FontModuleDrawText(psurface, pcd->fontmodule, offsetx + (px_int)(pObject->Width / 2),
                              offsety + (px_int)(pObject->Height - pcd->BottomSpacer + 32), PX_ALIGN_MIDBOTTOM, pcd->BottomTitle,
                              pcd->FontColor);
    }
...
static px_void PX_Object_OscilloscopeDrawDataInfo(px_surface *psurface, PX_Object *pObject,
                                                  px_double *Horizontal, px_double n, px_double *Vertical, px_int linewidth, px_int Size, px_int Map,
                                                  px_color Color)
{
    ...
    case PX_OBJECT_OSCILLOSCOPE_LINEMODE_PILLAR:
        {
            ...
            for (i = 0; i < Size; i++)
            {
                if (Horizontal[i] >= pcd->HorizontalRangeMin)
                {
                    ...
                    x = PX_Object_OscilloscopeMapHorizontalValueToPixel(pObject,
                                                                        Horizontal[i - 1]) - pcd->DataPillarWidth / 2;
                    ...
                    if (!(btm < pcd->TopSpacer || y > pObject->Height - pcd->BottomSpacer))
                    {
                        ...
                        if (x - (px_int)x > 0.1)
                        {
                            PX_GeoDrawRect(psurface, offsetx + (px_int)x, offsety + (px_int)y, offsetx + (px_int)(x + w),
                                           offsety + (px_int)(btm), Color);
                        }
                        else
                        {
                            PX_GeoDrawRect(psurface, offsetx + (px_int)x, offsety + (px_int)y, offsetx + (px_int)(x + w),
            ...
            for (i = 0; i < Size; i++)
            {
                ...
                if (Horizontal[i] >= pcd->HorizontalRangeMin)
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        if (PX_isLineCrossRect(PX_POINT((px_float)dx1, (px_float)dy1, 0), PX_POINT((px_float)dx2,
                                                                                                   (px_float)dy2, 0), PX_RECT((px_float)pcd->LeftSpacer, (px_float)pcd->TopSpacer,
                                                                                                           (px_float)PX_Object_OscilloscopeGetOscilloscopeWidth(pObject),
                                                                                                           (px_float)PX_Object_OscilloscopeGetOscilloscopeHeight(pObject)), &pt1, &pt2))
                        {
                            if (pcd->rendermode == PX_OBJECT_OSCILLOSCOPE_RENDER_MODE_SMOOTH)
                            {
                                PX_GeoDrawPenLine(psurface, (offsetx + pt1.x), (offsety + pt1.y), (offsetx + pt2.x),
                                                  (offsety + pt2.y), linewidth * 1.0f, Color);
                            }
                            else
                            {
                                PX_GeoDrawLine(psurface, (px_int)(offsetx + pt1.x), (px_int)(offsety + pt1.y),
                                               (px_int)(offsetx + pt2.x), (px_int)(offsety + pt2.y), linewidth, Color);
                            }
                ...
                if (Horizontal[i] > pcd->HorizontalRangeMax)
                {
                    if (i > 0)
                    {
                        ...
                        dy2 = PX_Object_OscilloscopeMapVerticalValueToPixel(pObject, Vertical[i] / n, Map);
                        if (PX_isLineCrossRect(PX_POINT((px_float)dx1, (px_float)dy1, 0), PX_POINT((px_float)dx2,
                                                                                                   (px_float)dy2, 0), PX_RECT((px_float)pcd->TopSpacer, (px_float)pcd->LeftSpacer,
                                                                                                           (px_float)PX_Object_OscilloscopeGetOscilloscopeWidth(pObject),
                                                                                                           (px_float)PX_Object_OscilloscopeGetOscilloscopeHeight(pObject)), &pt1, &pt2))
                        {
                            if (pcd->rendermode == PX_OBJECT_OSCILLOSCOPE_RENDER_MODE_SMOOTH)
    ...
    if (pcd->bDataUpdatePainter)
    {
        for (i = 0; i < pcd->vData.size; i++)
        {
            ...
            if (pData->Visibled)
            {
                ...
                {
                    PX_Object_OscilloscopeDrawDataInfo(psurface, pObject, pData->MapHorizontalArray, 1.0,
                                                       pData->MapVerticalArray, pData->linewidth, pData->Size, pData->Map, pData->Color);
                }
                else
                {
                    PX_Object_OscilloscopeDrawDataInfo(psurface, pObject, pData->MapHorizontalArray,
                                                       pData->Normalization, pData->MapVerticalArray, pData->linewidth, pData->Size, pData->Map,
                                                       pData->Color);
                }
            }
...
static px_void PX_Object_OscilloscopeDrawScaleDraging(px_surface *psurface, PX_Object *pObject)
{
    ...
    {
        PX_GeoDrawRect(psurface, offsetx + (px_int)pcd->DragStartPoint.x,
                       offsety + (px_int)pcd->DragStartPoint.y, offsetx + (px_int)pcd->DragingPoint.x,
                       offsety + (px_int)pcd->DragingPoint.y, PX_COLOR(96, 171, 81, 128));
    }
    else
    {
        PX_GeoDrawRect(psurface, offsetx + (px_int)pcd->DragStartPoint.x,
                       offsety + (px_int)pcd->DragStartPoint.y, offsetx + (px_int)pcd->DragingPoint.x,
                       offsety + (px_int)pcd->DragingPoint.y, PX_COLOR(96, 167, 233, 128));
    }
...
static px_void PX_Object_OscilloscopeDrawHelpLine(px_surface *psurface, PX_Object *pObject)
{
    ...
    value = PX_Object_OscilloscopeMapPixelValueToVertical(pObject, pcd->helpLineX,
                                                          PX_OBJECT_OSCILLOSCOPEDATA_MAP_HORIZONTAL);
    ...
    if (value > pcd->HorizontalRangeMin && value < pcd->HorizontalRangeMax)
    {
        ...
        PX_GeoDrawLine(psurface, (px_int)objx + x, (px_int)(objy + objHeight - pcd->BottomSpacer),
                       (px_int)objx + x, (px_int)objy + pcd->TopSpacer, (px_int)1, pcd->helpLineColor);
        ...
        PX_FontModuleDrawText(psurface, PX_NULL,
                              (px_int)(objx + X - PX_OBJECT_OSCILLOSCOPE_DEFAULT_FLAGTEXT_SPACER * 1.5), (px_int)objy + Y,
                              PX_ALIGN_LEFTTOP, text, pcd->helpLineColor);
    ...
    value = PX_Object_OscilloscopeMapPixelValueToVertical(pObject, pcd->helpLineY,
                                                          PX_OBJECT_OSCILLOSCOPEDATA_MAP_LEFT);
    ...
    if (value > pcd->LeftVerticalRangeMin && value < pcd->LeftVerticalRangeMax)
    {
        ...
        PX_GeoDrawLine(psurface, (px_int)objx + pcd->LeftSpacer, (px_int)objy + y,
                       (px_int)(objx + objWidth - pcd->RightSpacer), (px_int)objy + y, 1, pcd->helpLineColor);
        //Draw text
        ...
        PX_FontModuleDrawText(psurface, PX_NULL, (px_int)objx + X,
                              (px_int)objy + Y - PX_OBJECT_OSCILLOSCOPE_DEFAULT_FLAGTEXT_SPACER * 2 - 1, PX_ALIGN_LEFTTOP, text,
                              pcd->helpLineColor);
    ...
    value = PX_Object_OscilloscopeMapPixelValueToVertical(pObject, pcd->helpLineY,
                                                          PX_OBJECT_OSCILLOSCOPEDATA_MAP_RIGHT);
    ...
    if (value > pcd->RightVerticalRangeMin && value < pcd->RightVerticalRangeMax)
    {
        ...
        PX_GeoDrawLine(psurface, (px_int)objx + pcd->LeftSpacer, (px_int)objy + y,
                       (px_int)(objx + objWidth - pcd->RightSpacer), (px_int)objy + y, (px_int)(1), pcd->helpLineColor);
...
static px_void PX_Object_OscilloscopeDrawFlagLine(px_surface *psurface, PX_Object *pObject)
{
    ...
    {
        //Draw X line
        PX_Object_OscilloscopeFlagLine *pflgl = PX_VECTORAT(PX_Object_OscilloscopeFlagLine, &pcd->vFlagLine,
                                                            i);
        if (pflgl->XYshow & PX_OBJECT_OSCILLOSCOPEFLAGLINE_XSHOW)
        {
            if (pflgl->X >= pcd->HorizontalRangeMin && pflgl->X <= pcd->HorizontalRangeMax)
            {
                ...
                PX_GeoDrawLine(psurface, (px_int)objx + x, (px_int)((px_int)objy + objHeight - pcd->BottomSpacer),
                               (px_int)objx + x, (px_int)objy + pcd->TopSpacer, (px_int)pflgl->LineWidth, pflgl->color);
                //Draw text
                ...
                PX_FontModuleDrawText(psurface, PX_NULL,
                                      (px_int)((px_int)objx + X - PX_OBJECT_OSCILLOSCOPE_DEFAULT_FLAGTEXT_SPACER * 1.5), (px_int)objy + Y,
                                      PX_ALIGN_LEFTTOP, text, pcd->FontColor);
            }
        }
        ...
        if (pflgl->XYshow & PX_OBJECT_OSCILLOSCOPEFLAGLINE_XSHOW)
        {
            if (pflgl->Y >= pcd->LeftVerticalRangeMin && pflgl->Y <= pcd->LeftVerticalRangeMax)
            {
                ...
                px_char text[16];
                y = PX_Object_OscilloscopeMapVerticalValueToPixel(pObject, pflgl->Y,
                                                                  PX_OBJECT_OSCILLOSCOPEDATA_MAP_LEFT);

                PX_GeoDrawLine(psurface, (px_int)objx + pcd->LeftSpacer, (px_int)objy + y,
                               (px_int)((px_int)objx + objWidth - pcd->RightSpacer), (px_int)objy + y, (px_int)(pflgl->LineWidth),
                               pflgl->color);
                //Draw text
                ...
                PX_FontModuleDrawText(psurface, PX_NULL,
                                      (px_int)objx + X - 4 * PX_OBJECT_OSCILLOSCOPE_DEFAULT_FLAGTEXT_SPACER,
                                      (px_int)objy + Y - PX_OBJECT_OSCILLOSCOPE_DEFAULT_FLAGTEXT_SPACER, PX_ALIGN_LEFTTOP, text,
                                      pcd->FontColor);
            }
        }
...
px_void PX_Object_OscilloscopeDrawMarkLine(px_surface *psurface, PX_Object *pObject)
{
    ...
    if (pcd->MarkValueEnabled && pcd->OnMarkStatus)
    {
        if (pcd->MarkLineX != -1)
        {
            PX_GeoDrawLine(psurface, pcd->MarkLineX, pcd->TopSpacer, pcd->MarkLineX,
                           (px_int)(pObject->Height - pcd->BottomSpacer), 1, PX_COLOR(255, 255, 0, 0));
        }
    }
}
...
px_void PX_Object_OscilloscopeScaleOscilloscope(PX_Object *pObject)
{
    ...
    dMin = PX_Object_OscilloscopeMapPixelValueToVertical(pObject, (px_int)Min,
                                                         PX_OBJECT_OSCILLOSCOPEDATA_MAP_LEFT);
    dMax = PX_Object_OscilloscopeMapPixelValueToVertical(pObject, (px_int)Max,
                                                         PX_OBJECT_OSCILLOSCOPEDATA_MAP_LEFT);
...
px_void PX_Object_OscilloscopeCursorPressEvent(PX_Object *pObject, PX_Object_Event e, px_void *ptr)
{
    ...
    if (!PX_ObjectIsPointInRegion(pObject, PX_Object_Event_GetCursorX(e),
...
px_void PX_Object_OscilloscopeCursorReleaseEvent(PX_Object *pObject, PX_Object_Event e,
                                                 px_void *ptr)
{
...
PX_Object *PX_Object_OscilloscopeCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y,
                                        px_int Width, px_int Height, PX_FontModule *fontmodule)
{
    PX_Object *pObject;
    ...
    pObject = PX_ObjectCreateEx(mp, Parent, (px_float)x, (px_float)y, 0, (px_float)Width,
                                (px_float)Height, 0, PX_OBJECT_TYPE_OSCILLOSCOPE, PX_Object_OscilloscopeUpdate,
                                PX_Object_OscilloscopeRender, PX_Object_OscilloscopeFree, &Oscilloscope,
                                sizeof(PX_Object_Oscilloscope));

    //PX_ObjectRegisterEvent(pObject,PX_OBJECT_EVENT_CURSORMOVE,PX_Object_OscilloscopeCursorMoveEvent,PX_NULL);
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORMOVE, PX_Object_OscilloscopeCursorMoveEvent,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORDRAG, PX_Object_OscilloscopeCursorDragEvent,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORDOWN, PX_Object_OscilloscopeCursorPressEvent,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORUP, PX_Object_OscilloscopeCursorReleaseEvent,
                           PX_NULL);
...
PX_Object *PX_Designer_OscilloscopeCreate(px_memorypool *mp, PX_Object *pparent, px_float x,
                                          px_float y, px_float width, px_float height, px_void *ptr)
{
...
static px_void PX_Object_FilterEditorDrawFrameLine(px_surface *psurface, PX_Object *pObject)
{
    ...
    PX_GeoDrawLine(psurface, offsetx, offsety, offsetx + (px_int)(objWidth - 1), offsety,
                   PX_OBJECT_FILTEREDITOR_DEFAULT_FRAMELINE_WIDTH, pfe->borderColor);
    PX_GeoDrawLine(psurface, offsetx, offsety, offsetx, offsety + (px_int)(objHeight - 1),
                   PX_OBJECT_FILTEREDITOR_DEFAULT_FRAMELINE_WIDTH, pfe->borderColor);
    PX_GeoDrawLine(psurface, (px_int)(offsetx + objWidth - 1), offsety + (px_int)(objHeight - 1),
                   offsetx, offsety + (px_int)objHeight - 1, PX_OBJECT_OSCILLOSCOPE_DEFAULT_FRAMELINE_WIDTH,
                   pfe->borderColor);
    PX_GeoDrawLine(psurface, (px_int)(offsetx + objWidth - 1), offsety + (px_int)(objHeight - 1),
                   offsetx + (px_int)(objWidth - 1), offsety, PX_OBJECT_OSCILLOSCOPE_DEFAULT_FRAMELINE_WIDTH,
                   pfe->borderColor);
}
...
static px_void PX_Object_FilterEditorDrawSelectDraging(px_surface *psurface, PX_Object *pObject)
{
    ...
    PX_GeoDrawRect(psurface, (px_int)(offsetx + pfe->DragStartPoint.x),
                   (px_int)(offsety + (px_int)pfe->DragStartPoint.y), (px_int)(offsetx + (px_int)pfe->DragingPoint.x),
                   (px_int)(offsety + (px_int)pfe->DragingPoint.y), PX_COLOR(96, 171, 81, 128));
}
...
static px_void PX_Object_FilterEditorDrawPt(px_surface *psurface, PX_Object *pObject)
{
    ...
    {
        PX_GeoDrawSolidCircle(psurface, (px_int)(oftx + pfe->pt[i].x), (px_int)(ofty + pfe->pt[i].y),
                              pfe->radius, pfe->ptColor);
        if (pfe->pt[i].bselect || pfe->pt[i].bCursor)
        {
            PX_GeoDrawCircle(psurface, (px_int)(oftx + pfe->pt[i].x), (px_int)(ofty + pfe->pt[i].y),
                             pfe->radius + 2, 1, pfe->ptColor);
        }
    }

    for (i = 0; i < pfe->opCount - 1; i++)
    {
        PX_GeoDrawLine(psurface, (px_int)(oftx + pfe->pt[i].x), (px_int)(ofty + pfe->pt[i].y),
                       (px_int)(oftx + pfe->pt[i + 1].x), (px_int)(ofty + pfe->pt[i + 1].y), 2, pfe->ptColor);
    }
...
static px_void PX_Object_FilterEditorDrawHelpLine(px_surface *psurface, PX_Object *pObject)
{
    ...
    {
        //line
        PX_GeoDrawLine(psurface, (px_int)(oftx), (px_int)(ofty + y), (px_int)(oftx + objWidth),
                       (px_int)(ofty + y), 1, pfe->helpLineColor);
        ...
        //text
        PX_FontModuleDrawText(psurface, PX_NULL, (px_int)(oftx - 1), (px_int)(ofty + y - 5),
                              PX_ALIGN_RIGHTTOP, text, pfe->FontColor);
    }
    //down
    ...
    {
        //line
        PX_GeoDrawLine(psurface, (px_int)(oftx + x), (px_int)(ofty + 0), (px_int)(oftx + x),
                       (px_int)(ofty + objHeight - 1), 1, pfe->helpLineColor);
        val = x / objWidth;
        //text
        if (pfe->showHorizontal)
        {
            PX_sprintf1(text, sizeof(text), "%1.2", PX_STRINGFORMAT_FLOAT((px_float)val));
            PX_FontModuleDrawText(psurface, PX_NULL, (px_int)(oftx + x - 1), (px_int)(ofty + objHeight + 3),
                                  PX_ALIGN_CENTER, text, pfe->FontColor);
        }
    }

}

px_void PX_Object_FilterEditorCursorReleaseEvent(PX_Object *pObject, PX_Object_Event e,
                                                 px_void *ptr)
{
    PX_Object_FilterEditor *pfe = PX_Object_GetFilterEditor(pObject);
...
px_void PX_Object_FilterEditorCursorPressEvent(PX_Object *pObject, PX_Object_Event e, px_void *ptr)
{
    ...
    for (i = 0; i < pfe->opCount; i++)
    {
        if (PX_isPointInCircle(PX_POINT(x, y, 0), PX_POINT((px_float)pfe->pt[i].x, (px_float)pfe->pt[i].y,
                                                           0), (px_float)pfe->radius))
        {
            if (!pfe->pt[i].bselect)
            {
...
px_void PX_Object_FilterEditorCursorDragEvent(PX_Object *pObject, PX_Object_Event e, px_void *ptr)
{
    ...
    if (pfe->bSelectDrag)
    {
        ...
        rect = PX_RECT(pfe->DragStartPoint.x, pfe->DragStartPoint.y, x - pfe->DragStartPoint.x,
                       y - pfe->DragStartPoint.y);
        for (i = 0; i < pfe->opCount; i++)
        {
...
PX_Object *PX_Object_FilterEditorCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y,
                                        px_int Width, px_int Height, PX_OBJECT_FILTER_TYPE type)
{
    PX_Object *pObject;
    ...
    pObject = PX_ObjectCreateEx(mp, Parent, (px_float)x, (px_float)y, 0, (px_float)Width,
                                (px_float)Height, 0, PX_OBJECT_TYPE_FILTEREDITOR, PX_NULL, PX_Object_FilterEditorRender, PX_NULL,
                                &FilterEditor, sizeof(PX_Object_FilterEditor));
    PX_Object_FilterEditorSetOperateCount(pObject, 8);

    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORMOVE, PX_Object_FilterEditorCursorMoveEvent,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORDRAG, PX_Object_FilterEditorCursorDragEvent,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORDOWN, PX_Object_FilterEditorCursorPressEvent,
                           PX_NULL);
    PX_ObjectRegisterEvent(pObject, PX_OBJECT_EVENT_CURSORUP, PX_Object_FilterEditorCursorReleaseEvent,
                           PX_NULL);
    return pObject;
}
