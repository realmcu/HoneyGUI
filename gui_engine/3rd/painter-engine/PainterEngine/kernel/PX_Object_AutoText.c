...
PX_Object *PX_Object_AutoTextCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y,
                                    px_int width, PX_FontModule *fm)
{
    PX_Object *pObject;
    ...
    while (PX_TRUE)
    {
        ...
        if (pAt->fontModule)
        {
            ...
            else
            {
                if (psurface)
                {
                    PX_FontModuleDrawCharacter(psurface, pAt->fontModule, x_draw_oft, y_draw_oft, code,
                                               pAt->TextColor);
                }
                x_draw_oft += width;
            }
...
//edit
//////////////////////////////////////////////////////////////////////////
PX_Object *PX_Designer_AutoTextCreate(px_memorypool *mp, PX_Object *pparent, px_float x, px_float y,
