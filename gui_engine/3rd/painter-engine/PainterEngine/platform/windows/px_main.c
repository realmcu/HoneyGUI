...
DWORD WINAPI DEMO_RenderThreadFunc(LPVOID p)
{
    ...
    while (1)
    {
            ...
            case WM_SIZE:
                {
                    ...
                    if (width != 0 && height != 0)
                    {
                        ...
                        PX_WindowResize(App.runtime.surface_width, App.runtime.surface_height, (px_int)width,
                                        (px_int)height);
                        PX_RuntimeResize(&App.runtime, App.runtime.surface_width, App.runtime.surface_height, (px_int)width,
                                         (px_int)height);
                    }
                    continue;
            ...
            case WM_MOUSEWHEEL:
                {
                    ...
                    cursory = (px_float)((msg.lparam >> 16) & 0xffff) - rect.top - ((rect.bottom - rect.top) -
                                                                                    crect.bottom) + 2;
        ...
        PX_SystemRender(App.runtime.RenderSurface.surfaceBuffer, App.runtime.surface_width,
                        App.runtime.surface_height);
        Sleep(0);
    }
    return 0;
}
...
//  int WINAPI WinMain( __in HINSTANCE hInstance, __in_opt HINSTANCE hPrevInstance, __in LPSTR lpCmdLine, __in int nShowCmd )
{
    ...
    if (!PX_CreateWindow(App.runtime.surface_width, App.runtime.surface_height,
                         App.runtime.window_width, App.runtime.window_height, PX_APPLICATION_NAME))
    {
        return 0;
    }
