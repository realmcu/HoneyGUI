 ...
 */
void
jerry_register_magic_strings(const jerry_char_t *const
                             *ex_str_items_p, /**< character arrays, representing
                 ...
                 jerry_init_flag_t flags) /**< combination of Jerry flags */
{
    ...
    jerry_value_t parse_ret_val = jerry_parse(NULL, 0, script_source_p, script_source_size,
                                              JERRY_PARSE_NO_OPTS);
...
jerry_parse_function(const jerry_char_t
                     *resource_name_p,  /**< resource name (usually a file name) */
                     size_t resource_name_length, /**< length of resource name */
                      ...
                      jerry_size_t message_size) /**< size of the message in bytes */
{
    ...
    {
        return ecma_create_error_object_reference(ecma_new_standard_error((ecma_standard_error_t)
                                                                          error_type));
    }
    else
    {
        ...
        ecma_object_t *error_object_p = ecma_new_standard_error_with_message((
                                 ...
                                 jerry_size_t str_size) /**< string size */
{
    ...
    ecma_string_t *ecma_str_p = ecma_new_ecma_string_from_utf8_converted_to_cesu8((
 ...
 */
void
jerry_init_property_descriptor_fields(jerry_property_descriptor_t
                                      *prop_desc_p)  /**< [out] property descriptor */
{
                          ...
                          const jerry_property_descriptor_t *prop_desc_p) /**< property descriptor */
{
    ...
    prop_desc.is_enumerable = ECMA_BOOL_TO_BITFIELD(prop_desc_p->is_enumerable_defined ?
                                                    prop_desc_p->is_enumerable
                                                    : false);

    prop_desc.is_configurable_defined = ECMA_BOOL_TO_BITFIELD(prop_desc_p->is_configurable_defined);
    prop_desc.is_configurable = ECMA_BOOL_TO_BITFIELD(prop_desc_p->is_configurable_defined ?
                                                      prop_desc_p->is_configurable
                                                      : false);
    ...
    prop_desc.is_writable = ECMA_BOOL_TO_BITFIELD(prop_desc_p->is_writable_defined ?
                                                  prop_desc_p->is_writable
                                                  : false);
 ...
 */
void
jerry_free_property_descriptor_fields(const jerry_property_descriptor_t
...
jerry_objects_foreach(jerry_objects_foreach_t
                      foreach_p,  /**< function pointer of the iterator function */
 ...
 */
bool
jerry_objects_foreach_by_native_info(const jerry_object_native_info_t
                                     *native_info_p, /**< the type info
 ...
 */
bool
jerry_get_object_native_pointer(const jerry_value_t
                                obj_val,  /**< object to get native pointer from */
 ...
 */
void
jerry_set_object_native_pointer(const jerry_value_t
                                ...
                                bool is_resolve) /**< whether the promise should be resolved or rejected */
{
    ...
    ecma_value_t function = ecma_op_object_get_by_magic_id(ecma_get_object_from_value(promise),
                                                           prop_name);
 ...
 */
void
jerry_set_vm_exec_stop_callback(jerry_vm_exec_stop_callback_t
                                stop_cb,  /**< periodically called user function */
 ...
 */
bool
jerry_value_is_arraybuffer(const jerry_value_t
                           value)  /**< value to check if it is an ArrayBuffer */
{
    jerry_assert_api_available();
                                  ...
                                  jerry_object_native_free_callback_t free_cb) /**< buffer free callback */
{
    ...
    {
        return jerry_throw(ecma_raise_range_error(
                               ECMA_ERR_MSG("invalid buffer size or storage reference")));
    }
                              ...
                              uint8_t *element_size_shift) /**< [out] found element size shift value */
{
    ...
    for (uint32_t i = 0; i < sizeof(jerry_typedarray_mappings) / sizeof(jerry_typedarray_mappings[0]);
         i++)
    {
 ...
 */
jerry_value_t
jerry_create_typedarray_for_arraybuffer_sz(jerry_typedarray_type_t
                                           ...
                                           jerry_length_t length) /**< number of elements to use from ArrayBuffer */
{
    ...
    ecma_value_t array_value = ecma_op_create_typedarray(arguments_p, 3, prototype_obj_p,
                                                         element_size_shift, lit_id);
 ...
 */
jerry_value_t
jerry_create_typedarray_for_arraybuffer(jerry_typedarray_type_t
                                        type_name,  /**< type of TypedArray to create */
                                        const jerry_value_t arraybuffer) /**< ArrayBuffer to use */
{
    jerry_assert_api_available();
