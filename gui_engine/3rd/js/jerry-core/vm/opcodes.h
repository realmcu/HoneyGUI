...
ecma_value_t
do_number_bitwise_logic(number_bitwise_logic_op op, ecma_value_t left_value,
...
void
opfunc_set_accessor(bool is_getter, ecma_value_t object, ecma_string_t *accessor_name_p,
