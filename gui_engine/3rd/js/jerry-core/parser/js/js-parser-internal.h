...
#ifdef JERRY_DEBUGGER
    parser_breakpoint_info_t
    breakpoint_info[PARSER_MAX_BREAKPOINT_INFO_COUNT]; /**< breakpoint info list */
...
void parser_stack_iterator_write(parser_stack_iterator_t *iterator, const void *data_p,
                                 size_t length);
...
void parser_emit_cbc_forward_branch(parser_context_t *context_p, uint16_t opcode,
                                    parser_branch_t *branch_p);
parser_branch_node_t *parser_emit_cbc_forward_branch_item(parser_context_t *context_p,
                                                          uint16_t opcode,
...
void parser_set_breaks_to_current_position(parser_context_t *context_p,
                                           parser_branch_node_t *current_p);
void parser_set_continues_to_current_position(parser_context_t *context_p,
                                              parser_branch_node_t *current_p);
...
ecma_char_t lexer_hex_to_character(parser_context_t *context_p, const uint8_t *source_p,
                                   int length);
...
bool lexer_construct_number_object(parser_context_t *context_p, bool is_expr,
...
bool lexer_compare_identifier_to_current(parser_context_t *context_p,
...
void parser_scan_until(parser_context_t *context_p, lexer_range_t *range_p,
                       lexer_token_type_t end_type);
...
#ifndef CONFIG_DISABLE_ES2015_ARROW_FUNCTION
ecma_compiled_code_t *parser_parse_arrow_function(parser_context_t *context_p,
...
void parser_append_breakpoint_info(parser_context_t *context_p, jerry_debugger_header_type_t type,
                                   uint32_t value);
