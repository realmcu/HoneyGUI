 ...
 */
static ecma_value_t
ecma_builtin_object_object_get_own_property_descriptor(ecma_value_t
                                             ...
                                             ecma_value_t arg2) /**< routine's second argument */
{
    ...
    else
    {
        ...
        /* 3. */
        ecma_collection_header_t *prop_names_p = ecma_op_object_get_property_names(props_p, false, true,
                                                                                   false);
