...
ecma_builtin_helper_object_to_string(const ecma_value_t this_arg)  /**< this argument */
{
    ...
    ret_string_p = ecma_new_ecma_string_from_utf8(str_buffer,
                                                  (lit_utf8_size_t)(buffer_ptr - str_buffer));
                                                     ...
                                                     bool first_index) /**< routine's third argument */
{
    ...
    if (ecma_builtin_helper_string_find_index(original_str_p, search_str_p, first_index, start,
                                              &index_of))
    {
