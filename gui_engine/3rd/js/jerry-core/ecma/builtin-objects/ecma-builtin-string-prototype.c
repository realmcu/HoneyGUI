                                             ...
                                             bool charcode_mode) /**< routine mode */
{
     ...
     */
    JERRY_ASSERT(ecma_number_is_nan(index_num) ||
                 ecma_number_to_uint32(index_num) == ecma_number_trunc(index_num));

    ecma_char_t new_ecma_char = ecma_string_get_char_at_pos(original_string_p,
                                                            ecma_number_to_uint32(index_num));
    ecma_free_value(to_string_val);
...
ecma_builtin_string_prototype_object_replace_append_substr(ecma_string_t
                                                           *base_string_p,  /**< base string */
 ...
 */
static ecma_value_t
ecma_builtin_string_prototype_object_replace_match(ecma_builtin_replace_search_ctx_t
                                                   *context_p) /**< search
                                                                                                   * context */
{
    ecma_value_t ret_value = ECMA_VALUE_EMPTY;
    ...
    if (context_p->is_regexp)
    {
        ...
        if (!ecma_is_value_null(match_value))
        {
            ...
            context_p->match_end = context_p->match_start + (ecma_length_t) ecma_string_get_length(
                                       result_string_p);
 ...
 */
static ecma_value_t
ecma_builtin_string_prototype_object_replace_get_string(ecma_builtin_replace_search_ctx_t
                                                        *context_p, /**< search
                                                                                                        * context */
                                                        ecma_value_t match_value) /**< returned match value */
{
    ...
    else
    {
        ...
        lit_utf8_byte_t *replace_str_end_p = replace_str_curr_p + ecma_string_get_size(
 ...
 */
static ecma_value_t
ecma_builtin_string_prototype_object_replace_loop(ecma_builtin_replace_search_ctx_t
                                                  *context_p) /**< search
                                                                                                  * context */
{
    ecma_value_t ret_value = ECMA_VALUE_EMPTY;
 ...
 */
static ecma_value_t
ecma_builtin_string_prototype_object_replace_main(ecma_builtin_replace_search_ctx_t
                                                  *context_p, /**< search
                                                                                                  * context */
 ...
 */
static ecma_value_t
ecma_builtin_string_prototype_object_to_locale_lower_case(ecma_value_t
                                                          this_arg)  /**< this argument */
{
    return ecma_builtin_string_prototype_object_conversion_helper(this_arg, true);
 ...
 */
static ecma_value_t
ecma_builtin_string_prototype_object_to_locale_upper_case(ecma_value_t
                                                          this_arg)  /**< this argument */
{
    return ecma_builtin_string_prototype_object_conversion_helper(this_arg, false);
                                            ...
                                            ecma_value_t length) /**< routine's second argument */
{
    ...
    if (ecma_is_value_empty(ret_value))
    {
        ...
        uint32_t from = ecma_builtin_helper_string_index_normalize(from_num,
                                                                   ecma_number_to_uint32(this_len), true);

        /* 6-7. */
        ecma_number_t to_num = JERRY_MAX(JERRY_MIN(JERRY_MAX(length_num, 0), this_len - from_num), 0);
        uint32_t to = from + ecma_builtin_helper_string_index_normalize(to_num,
                                                                        ecma_number_to_uint32(this_len), true);
