...
ecma_value_t
ecma_builtin_helper_array_concat_value(ecma_object_t *obj_p, uint32_t *length_p,
                                       ecma_value_t value);
uint32_t
...
ecma_number_t ecma_date_make_time(ecma_number_t hour, ecma_number_t min, ecma_number_t sec,
                                  ecma_number_t ms);
...
bool ecma_json_has_object_in_stack(ecma_json_occurence_stack_item_t *stack_p,
                                   ecma_object_t *object_p);
bool ecma_has_string_value_in_collection(ecma_collection_header_t *collection_p,
                                         ecma_value_t string_value);

ecma_value_t
ecma_builtin_helper_json_create_formatted_json(lit_utf8_byte_t left_bracket,
...
ecma_value_t
ecma_builtin_helper_json_create_non_formatted_json(lit_utf8_byte_t left_bracket,
                                                   lit_utf8_byte_t right_bracket,
