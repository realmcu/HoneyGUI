 ...
 */
uint8_t
ecma_typedarray_helper_get_magic_string(uint8_t
                                        builtin_id)  /**< the builtin id of the typedarray **/
{
 ...
 */
uint8_t
ecma_typedarray_helper_get_prototype_id(uint8_t
                                        builtin_id)  /**< the builtin id of the typedarray **/
{
 ...
 */
ecma_value_t
ecma_typedarray_helper_dispatch_construct(const ecma_value_t
                                          ...
                                          uint8_t builtin_id) /**< the builtin id of the typedarray */
{
    ...
    ecma_object_t *prototype_obj_p = ecma_builtin_get(ecma_typedarray_helper_get_prototype_id(
                                                          builtin_id));
