...
ecma_builtin_array_prototype_object_reverse(ecma_value_t this_arg)  /**< this argument */
{
    ...
    for (uint32_t lower = 0; lower < middle && ecma_is_value_empty(ret_value); lower++)
    {
        ...
        {
            ECMA_TRY_CATCH(outer_put_value, ecma_op_object_put(obj_p, lower_str_p, upper_value, true),
                           ret_value);
            ECMA_TRY_CATCH(inner_put_value, ecma_op_object_put(obj_p, upper_str_p, lower_value, true),
                           ret_value);
                                         ...
                                         ecma_value_t arg1) /**< comparefn */
{
    ...
    ecma_collection_header_t *array_index_props_p = ecma_op_object_get_property_names(obj_p, true,
                                                    false, false);
