...
__STATIC_FORCEINLINE void VT_enter_global_mutex(void)
{
    // User defined code to enter a global mutex
    // e.g. disable interrupts or lock a mutex
}
__STATIC_FORCEINLINE void VT_leave_global_mutex(void)
{
    // User defined code to leave a global mutex
    // e.g. enable interrupts or unlock a mutex
}
