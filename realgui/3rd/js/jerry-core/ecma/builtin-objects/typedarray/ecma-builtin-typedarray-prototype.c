                                               ...
                                               typedarray_routine_mode mode) /**< mode: which routine */
{
    ...
    for (uint32_t index = 0; index < len && ecma_is_value_empty(ret_value); index++)
    {
        ...
        ECMA_TRY_CATCH(call_value, ecma_op_function_call(func_object_p, cb_this_arg, call_args, 3),
                       ret_value);
                                      ...
                                      ecma_value_t cb_this_arg) /**< this' of the callback function */
{
    ...
    for (uint32_t index = 0; index < len && ecma_is_value_empty(ret_value); index++)
    {
        ...
        ECMA_TRY_CATCH(mapped_value, ecma_op_function_call(func_object_p, cb_this_arg, call_args, 3),
                       ret_value);
 ...
 */
static ecma_value_t
ecma_builtin_typedarray_prototype_reduce_with_direction(ecma_value_t
