...
ecma_builtin_get_property_count(ecma_builtin_id_t builtin_id)  /**< built-in ID */
{
    const ecma_builtin_property_descriptor_t *property_list_p =
        ecma_builtin_property_list_references[builtin_id];
 ...
 */
static ecma_object_t *
ecma_builtin_make_function_object_for_routine(ecma_builtin_id_t
                                              builtin_id,  /**< identifier of built-in object */
 ...
 */
static ecma_object_t *
ecma_builtin_make_function_object_for_getter_accessor(ecma_builtin_id_t
                                                      builtin_id,  /**< id of built-in object */
 ...
 */
static ecma_object_t *
ecma_builtin_make_function_object_for_setter_accessor(ecma_builtin_id_t
                                                      builtin_id,  /**< id of built-in object */
                                                      uint16_t routine_id) /**< builtin-wide id of the built-in
                                                                            *   object's routine property */
{
                                         ...
                                         ecma_string_t *string_p) /**< property's name */
{
        ...
        && ecma_builtin_function_is_routine(object_p))
    {
        if (ecma_string_is_length(string_p))
        {
            ...
            uint8_t length = ext_obj_p->u.built_in.length_and_bitset_size & ((1 << ECMA_BUILT_IN_BITSET_SHIFT) -
                                                                             1);
                                                                                         ...
                                                                                         *   collection */
{
    ...
    else
    {
        ...
        while (curr_property_p->magic_string_id != LIT_MAGIC_STRING__COUNT)
        {
            ...
            ecma_string_t *name_p = ecma_get_magic_string((lit_magic_string_id_t)
            ...
            {
                ecma_value_t name = ecma_make_magic_string_value((lit_magic_string_id_t)
                                                                 curr_property_p->magic_string_id);
 ...
 */
static ecma_value_t
ecma_builtin_dispatch_routine(ecma_builtin_id_t
                              builtin_object_id,  /**< built-in object' identifier */
                           ...
                           ecma_length_t arguments_list_len) /**< arguments list length */
{
    ...
    else
    {
        ...
        JERRY_ASSERT(builtin_object_id < sizeof(ecma_builtin_call_functions) / sizeof(
                         ecma_builtin_dispatch_call_t));
                                ...
                                ecma_length_t arguments_list_len) /**< arguments list length */
{
    ...
    ecma_extended_object_t *ext_obj_p = (ecma_extended_object_t *) obj_p;
    ecma_builtin_id_t builtin_object_id = ext_obj_p->u.built_in.id;
    JERRY_ASSERT(builtin_object_id < sizeof(ecma_builtin_construct_functions) / sizeof(
                     ecma_builtin_dispatch_call_t));
