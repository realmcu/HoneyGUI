...
ROUTINE(LIT_MAGIC_STRING_GET_OWN_PROPERTY_NAMES_UL,
        ecma_builtin_object_object_get_own_property_names, 1, 1)
...
ROUTINE(LIT_MAGIC_STRING_GET_OWN_PROPERTY_DESCRIPTOR_UL,
        ecma_builtin_object_object_get_own_property_descriptor, 2, 2)
