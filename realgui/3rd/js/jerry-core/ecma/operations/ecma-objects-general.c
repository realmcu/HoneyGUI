 ...
 */
ecma_object_t *
ecma_op_create_object_object_noarg_and_set_prototype(ecma_object_t
                                                     *object_prototype_p) /**< pointer to prototype of
                                                                                              the object
                                                                                              (can be NULL) */
{
                                           ...
                                           bool is_throw) /**< flag that controls failure handling */
{
    ...
    else
    {
        ...
        prop_flags = (ecma_property_t)(prop_flags & ~(ECMA_PROPERTY_TYPE_MASK |
    ...
    {
        JERRY_ASSERT(ECMA_PROPERTY_GET_TYPE(*ext_property_ref.property_p) ==
