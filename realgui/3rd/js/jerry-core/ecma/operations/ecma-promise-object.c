...
ecma_promise_create_resolving_functions(ecma_object_t *object_p)  /**< the promise object */
{
    ...
    /* 8. */
    ecma_promise_resolving_functions_t *funcs = jmem_heap_alloc_block(sizeof(
                                                                          ecma_promise_resolving_functions_t));
 ...
 */
void
ecma_promise_free_resolving_functions(ecma_promise_resolving_functions_t
                                      *funcs)  /**< points to the functions */
{
