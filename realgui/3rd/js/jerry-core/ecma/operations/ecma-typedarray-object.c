 ...
 */
void
ecma_set_typedarray_element(lit_utf8_byte_t
                            *dst_p,  /**< the location in the internal arraybuffer */
 ...
 */
ecma_value_t
ecma_typedarray_create_object_with_length(ecma_length_t
                                          array_length,  /**< length of the typedarray */
...
ecma_typedarray_create_object_with_buffer(ecma_object_t
                                          *arraybuffer_p,  /**< the arraybuffer inside */
                                          ...
                                          lit_magic_string_id_t class_id) /**< class name of the typedarray */
{
    ...
    if (needs_ext_typedarray_obj)
    {
        ...
        ecma_extended_typedarray_object_t *typedarray_info_p = (ecma_extended_typedarray_object_t *)
                                                               object_p;
 ...
 */
static ecma_value_t
ecma_typedarray_create_object_with_typedarray(ecma_object_t
                                              *typedarray_p,  /**< a typedarray object */
                                              ecma_object_t *proto_p, /**< prototype object */
                                              uint8_t element_size_shift, /**< the size shift of the element length */
                                              lit_magic_string_id_t class_id) /**< class name of the typedarray */
{
        ...
        for (uint32_t index = 0; index < len && ecma_is_value_empty(ret_value); index++)
        {
            ...
            if (ecma_is_value_found(current_value))
            {
                if (func_object_p != NULL)
                {
                    ...
                    ECMA_TRY_CATCH(mapped_value, ecma_op_function_call(func_object_p, this_val, call_args, 2),
                                   ret_value);
...
ecma_typedarray_get_arraybuffer(ecma_object_t
                                *typedarray_p)  /**< the pointer to the typedarray object */
{
 ...
 */
uint8_t
ecma_typedarray_get_element_size_shift(ecma_object_t
                                       *typedarray_p)  /**< the pointer to the typedarray object */
{
    JERRY_ASSERT(ecma_is_typedarray(ecma_make_object_value(typedarray_p)));
 ...
 */
ecma_length_t
ecma_typedarray_get_length(ecma_object_t
                           *typedarray_p)  /**< the pointer to the typedarray object */
{
    JERRY_ASSERT(ecma_is_typedarray(ecma_make_object_value(typedarray_p)));
    ...
    {
        ecma_object_t *arraybuffer_p = ecma_get_object_from_value(
                                           ext_object_p->u.pseudo_array.u2.arraybuffer);
 ...
 */
ecma_length_t
ecma_typedarray_get_offset(ecma_object_t
                           *typedarray_p)  /**< the pointer to the typedarray object */
{
    JERRY_ASSERT(ecma_is_typedarray(ecma_make_object_value(typedarray_p)));
 ...
 */
lit_utf8_byte_t *
ecma_typedarray_get_buffer(ecma_object_t
                           *typedarray_p)  /**< the pointer to the typed array object */
{
...
ecma_op_create_typedarray(const ecma_value_t
                          *arguments_list_p,  /**< the arg list passed to typedarray construct */
                          ...
                          lit_magic_string_id_t class_id) /**< class name of the typedarray */
{
    ...
    else if (ecma_is_value_object(arguments_list_p[0]))
    {
        ...
        else if (ecma_is_arraybuffer(arguments_list_p[0]))
        {
            ...
            if (ecma_number_is_negative(ecma_number_to_int32(num2)) ||
                (offset % (uint32_t)(1 << element_size_shift) != 0))
            {
