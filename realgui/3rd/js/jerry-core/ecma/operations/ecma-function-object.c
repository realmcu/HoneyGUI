 ...
 */
ecma_object_t *
ecma_op_create_external_function_object(ecma_external_handler_t
                                        handler_cb)  /**< pointer to external native handler */
{
    ecma_object_t *prototype_obj_p = ecma_builtin_get(ECMA_BUILTIN_ID_FUNCTION_PROTOTYPE);
 ...
 */
inline const ecma_compiled_code_t *JERRY_ATTR_ALWAYS_INLINE
ecma_op_arrow_function_get_compiled_code(ecma_arrow_function_t
                                         *arrow_function_p)  /**< arrow function pointer */
{
#ifdef JERRY_ENABLE_SNAPSHOT_EXEC
...
ecma_op_function_set_construct_flag(const ecma_value_t
                                    *arguments_list_p)  /**< original arguments list pointer */
{
    /* Any ecma value list must be aligned to 4 byte. */
    JERRY_ASSERT((((uintptr_t) arguments_list_p) & 0x3) == 0);

#ifndef CONFIG_DISABLE_ES2015_CLASS
    arguments_list_p = (const ecma_value_t *)(((uintptr_t) arguments_list_p) |
                                              ECMA_CLASS_CONSTRUCT_FLAG);
#endif /* !CONFIG_DISABLE_ES2015_CLASS */
 ...
 */
static inline const ecma_value_t *JERRY_ATTR_ALWAYS_INLINE
ecma_op_function_clear_construct_flag(const ecma_value_t
                                      *arguments_list_p)  /**< modified arguments list pointer */
{
#ifndef CONFIG_DISABLE_ES2015_CLASS
    arguments_list_p = (const ecma_value_t *)(((uintptr_t) arguments_list_p) &
                                              ~ECMA_CLASS_CONSTRUCT_FLAG);
...
ecma_op_function_has_construct_flag(const ecma_value_t
                                    *arguments_list_p)  /**< modified arguments list pointer */
{
#ifndef CONFIG_DISABLE_ES2015_CLASS
                      ...
                      ecma_length_t arguments_list_len) /**< length of arguments list */
{
    ...
    while (true)
    {
        ...
        if (func_type == ECMA_OBJECT_TYPE_FUNCTION)
        {
            ...
            is_no_lex_env = (bytecode_data_p->status_flags & CBC_CODE_FLAGS_LEXICAL_ENV_NOT_NEEDED) ? true :
                            false;
        ...
        else if (func_type == ECMA_OBJECT_TYPE_ARROW_FUNCTION)
        {
            ...
            const ecma_compiled_code_t *bytecode_data_p = ecma_op_arrow_function_get_compiled_code(
                                                              arrow_func_p);
        ...
        memcpy(merged_args_list_p + args_length, arguments_list_p,
               arguments_list_len * sizeof(ecma_value_t));
 ...
 */
ecma_property_t *
ecma_op_function_try_to_lazy_instantiate_property(ecma_object_t
                                                  *object_p,  /**< the function object */
 ...
 */
void
ecma_op_external_function_list_lazy_property_names(bool
                                                   separate_enumerable, /**< true - list enumerable properties
 ...
 */
void
ecma_op_bound_function_list_lazy_property_names(bool
                                                separate_enumerable, /**< true - list enumerable properties
                                                                            *          into main collection and
                                                                            *          non-enumerable to collection
                                                                            *          of 'skipped non-enumerable'
