 ...
 */
void
jerry_debugger_transport_add(jerry_debugger_transport_header_t
                             *header_p,  /**< transport implementation */
                             ...
                             size_t max_receive_message_size) /**< maximum number of bytes received in a message */
{
    ...
    JERRY_ASSERT(max_receive_size > JERRY_DEBUGGER_TRANSPORT_MIN_BUFFER_SIZE +
                 receive_message_header_size);
 ...
 */
bool
jerry_debugger_transport_receive(jerry_debugger_transport_receive_context_t
                                 *context_p) /**< [out] receive
                                                                                          *   context */
{
    JERRY_ASSERT(jerry_debugger_transport_is_connected());
 ...
 */
void
jerry_debugger_transport_receive_completed(jerry_debugger_transport_receive_context_t
                                           *context_p) /**< receive
                                                                                                    *   context */
{
