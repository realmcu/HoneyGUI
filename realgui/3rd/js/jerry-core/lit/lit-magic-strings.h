...
lit_magic_string_id_t lit_is_utf8_string_magic(const lit_utf8_byte_t *string_p,
...
lit_magic_string_ex_id_t lit_is_ex_utf8_string_magic(const lit_utf8_byte_t *string_p,
                                                     lit_utf8_size_t string_size);
...
lit_utf8_byte_t *lit_copy_magic_string_to_buffer(lit_magic_string_id_t id,
