...
PX_Object *PX_UI_CreateNode(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value, px_int width,
                            px_int height)
{
    return PX_ObjectCreate(ui->ui_mp, parent, 0, 0, 0, 0, 0, 0);
}

PX_Object *PX_UI_CreateLabel(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value, px_int width,
                             px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_LabelCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                    (px_int)baseInfo.width, (px_int)baseInfo.height, text, ui->fontmodule, fontColor);
                                  ...
                                  px_int width, px_int height)
{
    ...
    pObject = PX_Object_ProcessBarCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                         (px_int)baseInfo.width, (px_int)baseInfo.height);
...
PX_Object *PX_UI_CreateImage(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value, px_int width,
                             px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_ImageCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                    (px_int)baseInfo.width, (px_int)baseInfo.height, PX_NULL);
                                 ...
                                 px_int width, px_int height)
{
    ...
    if (pSubValue && pSubValue->type == PX_JSON_VALUE_TYPE_STRING &&
        PX_strequ(pSubValue->_string.buffer, "vertical"))
    {
    ...
    if (pSubValue && pSubValue->type == PX_JSON_VALUE_TYPE_STRING &&
        PX_strequ(pSubValue->_string.buffer, "liner"))
    {
        style = PX_OBJECT_SLIDERBAR_STYLE_LINER;
    }

    pObject = PX_Object_SliderBarCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                        (px_int)baseInfo.width, (px_int)baseInfo.height, type, style);
    if (pObject)
    {
...
PX_Object *PX_UI_CreateButton(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value, px_int width,
                              px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_PushButtonCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                         (px_int)baseInfo.width, (px_int)baseInfo.height, text, ui->fontmodule);
...
PX_Object *PX_UI_CreateEdit(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value, px_int width,
                            px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_EditCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                   (px_int)baseInfo.width, (px_int)baseInfo.height, ui->fontmodule);
...
PX_Object *PX_UI_CreateScrollArea(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value,
                                  px_int width, px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_ScrollAreaCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                         (px_int)baseInfo.width, (px_int)baseInfo.height);
...
PX_Object *PX_UI_CreateAutoText(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value,
                                px_int width, px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_AutoTextCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                       (px_int)baseInfo.width, ui->fontmodule);
...
PX_Object *PX_UI_CreateCursorButton(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value,
                                    px_int width, px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_CursorButtonCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                           (px_int)baseInfo.width, (px_int)baseInfo.height, text, ui->fontmodule, fontColor);
    ...
    if (PX_UI_GetString(json_value, "style", style, sizeof(style)))
    {
        if (PX_strequ(style, "round"))
        {
            PX_Object_PushButtonSetStyle(PX_Object_GetCursorButton(pObject)->pushbutton,
...
PX_Object *PX_UI_CreateVirtualKeyboard(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value,
                                       px_int width, px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_VirtualKeyBoardCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                              (px_int)baseInfo.width, (px_int)baseInfo.height);
...
PX_Object *PX_UI_CreateVirtualNumberKeyboard(PX_UI *ui, PX_Object *parent,
                                             PX_Json_Value *json_value, px_int width, px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    PX_Json_Value *pSubValue = PX_NULL;
    ...
    pObject = PX_Object_VirtualNumberKeyBoardCreate(ui->ui_mp, parent, (px_int)baseInfo.x,
                                                    (px_int)baseInfo.y, (px_int)baseInfo.width, (px_int)baseInfo.height);
...
PX_Object *PX_UI_CreateCheckBox(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value,
                                px_int width, px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_CheckBoxCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                       (px_int)baseInfo.width, (px_int)baseInfo.height, text, ui->fontmodule);
...
PX_Object *PX_UI_CreateRadioBox(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value,
                                px_int width, px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_RadioBoxCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                       (px_int)baseInfo.width, (px_int)baseInfo.height, text, ui->fontmodule);
...
PX_Object *PX_UI_CreateSelectBar(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value,
                                 px_int width, px_int height)
{
    PX_Object *pObject;
    PX_UiBaseInfo baseInfo;
    ...
    pObject = PX_Object_SelectBarCreate(ui->ui_mp, parent, (px_int)baseInfo.x, (px_int)baseInfo.y,
                                        (px_int)baseInfo.width, (px_int)baseInfo.height, ui->fontmodule);
...
px_bool PX_UIAddControllerInfo(PX_UI *ui, const px_char controllertype[],
                               PX_UI_ControllerCreate _func)
{
...
PX_Object *PX_UICreate(PX_UI *ui, PX_Object *parent, PX_Json_Value *json_value, px_int width,
                       px_int height)
{
    //key properties
    //type   default root
    ...
    else
    {
        ...
        pNewObject = PX_ObjectCreate(ui->ui_mp, parent, baseInfo.x, baseInfo.y, baseInfo.z, baseInfo.width,
                                     baseInfo.height, baseInfo.length);
        if (!pNewObject)
        {
            goto _ERROR;
        }
    ...
    {
        if (PX_MapGet(&ui->ObjectMap, (const px_byte *)pSubValue->_string.buffer,
                      PX_strlen(pSubValue->_string.buffer)))
        {
            //"Repeat controller"
            PX_ASSERT();
            goto _ERROR;
        }
        if (PX_MapPut(&ui->ObjectMap, (const px_byte *)pSubValue->_string.buffer,
                      PX_strlen(pSubValue->_string.buffer), pNewObject) != PX_HASHMAP_RETURN_OK)
        {
            goto _ERROR;
        }
    }
...
px_void PX_UIUpdateObjectsPostions(PX_UI *ui, PX_Object *pObject, PX_Json_Value *json_value,
                                   px_int width, px_int height)
{
    PX_UiBaseInfo baseInfo;
    PX_Json_Value *pSubValue = PX_NULL;
