...
px_void PX_Object_PianoRender(px_surface *psurface, PX_Object *pObject, px_dword elapsed)
{
    ...
    while (j--)
    {
        ...
        for (i = 0; i < 88; i++)
        {
            ...
            PX_GeoDrawBorder(psurface, (px_int)x, (px_int)objy, (px_int)(x + keyw), (px_int)(objy + keyh), 1,
                             PX_COLOR_BLACK);
            ...
            case PX_OBJECT_PIANO_KEYSTATE_DOWN:
                PX_GeoDrawRect(psurface, (px_int)x, (px_int)objy, (px_int)(x + keyw), (px_int)(objy + keyh),
                               PX_COLOR(128, 64, 64, 255));
                break;
            case PX_OBJECT_PIANO_KEYSTATE_CURSOR:
                PX_GeoDrawRect(psurface, (px_int)x, (px_int)objy, (px_int)(x + keyw), (px_int)(objy + keyh),
                               PX_COLOR(96, 192, 255, 64));
                break;
            case PX_OBJECT_PIANO_KEYSTATE_ONFOCUS:
                PX_GeoDrawRect(psurface, (px_int)x, (px_int)objy, (px_int)(x + keyw), (px_int)(objy + keyh),
                               PX_COLOR(96, 255, 192, 64));
                break;
            }
        }
    }
...
px_void PX_Object_PianoOnCursorMove(PX_Object *pObject, PX_Object_Event e, px_void *ptr)
{
    ...
    index = PX_Object_PianoCursorInkeyIndex(pObject, PX_Object_Event_GetCursorX(e),
                                            PX_Object_Event_GetCursorY(e));
    if (index != -1)
    {
...
PX_Object *PX_Object_PianoCreate(px_memorypool *mp, PX_Object *Parent, px_float x, px_float y,
                                 px_float width, px_float height)
{
    PX_Object_Piano Piano;
    PX_Object *pObject;
    PX_zeromemory(&Piano, sizeof(Piano));
    pObject = PX_ObjectCreateEx(mp, Parent, x, y, 0, width, height, 0, PX_OBJECT_TYPE_PIANO, PX_NULL,
                                PX_Object_PianoRender, PX_NULL, &Piano, sizeof(Piano));
...
px_void PX_Object_PianoTune_LocalToUI(PX_Object *pObject)
{
    ...
    PX_sprintf1(content, sizeof(content), "Key pulsation velocity weight:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.weight));
    ...
    PX_sprintf1(content, sizeof(content), "minimum string radio:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.minr));
    ...
    PX_sprintf1(content, sizeof(content), "maximum string radio:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.maxr));
    ...
    PX_sprintf1(content, sizeof(content), "radius left sigmoidal shape:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.amprl));
    ...
    PX_sprintf1(content, sizeof(content), "radius right sigmoidal shape:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.amprr));
    ...
    PX_sprintf1(content, sizeof(content), "cord nucleus radio:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_radius_core_string));
    ...
    PX_sprintf1(content, sizeof(content), "minimum string length:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.minL));
    ...
    PX_sprintf1(content, sizeof(content), "maximum string length:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.maxL));
    ...
    PX_sprintf1(content, sizeof(content), "length left sigmoidal shape:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.ampLl));
    ...
    PX_sprintf1(content, sizeof(content), "length right sigmoidal shape:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.ampLr));
    ...
    PX_sprintf1(content, sizeof(content), "string density:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_density_string));
    ...
    PX_sprintf1(content, sizeof(content), "young modulus:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_modulus_string));
    ...
    PX_sprintf1(content, sizeof(content), "bridge impedance:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_impedance_bridge));
    ...
    PX_sprintf1(content, sizeof(content), "hammer impedance:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_impedance_hammer));
    ...
    PX_sprintf1(content, sizeof(content), "mass hammer:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_mass_hammer));
    ...
    PX_sprintf1(content, sizeof(content), "force hammer:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_force_hammer));
    ...
    PX_sprintf1(content, sizeof(content), "hysteresys hammer:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_hysteresis_hammer));
    ...
    PX_sprintf1(content, sizeof(content), "stiffness exponent hammer:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_stiffness_exponent_hammer));
    ...
    PX_sprintf1(content, sizeof(content), "position hammer:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.position_hammer));
    ...
    PX_sprintf1(content, sizeof(content), "string loss factor:%1.2",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.mult_loss_filter));
    ...
    PX_sprintf1(content, sizeof(content), "detuning among 3 strings:%1.6",
                PX_STRINGFORMAT_FLOAT(pTune->key_param.detune));
    ...
    PX_sprintf1(content, sizeof(content), "global soundboard eq1:%1",
                PX_STRINGFORMAT_INT((px_int)pTune->soundboard_param.eq1));
    ...
    PX_sprintf1(content, sizeof(content), "global soundboard eq2:%1",
                PX_STRINGFORMAT_INT((px_int)pTune->soundboard_param.eq2));
    ...
    PX_sprintf1(content, sizeof(content), "global soundboard eq3:%1",
                PX_STRINGFORMAT_INT((px_int)pTune->soundboard_param.eq3));
    ...
    PX_sprintf1(content, sizeof(content), "global soundboard c1:%1",
                PX_STRINGFORMAT_INT((px_int)pTune->soundboard_param.c1));
    ...
    PX_sprintf1(content, sizeof(content), "global soundboard c3:%1",
                PX_STRINGFORMAT_INT((px_int)pTune->soundboard_param.c3));
...
px_void PX_Object_PianoTune_mult_radius_core_stringOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                             px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_density_stringOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                         px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_modulus_stringOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                         px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_impedance_bridgeOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                           px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_impedance_hammerOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                           px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_mass_hammerOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                      px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_force_hammerOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                       px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_hysteresis_hammerOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                            px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_stiffness_exponent_hammerOnChanged(PX_Object *pObject,
                                                                    PX_Object_Event e, px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
    fvalue = PX_Object_SliderBarGetValue(pObject) / 100.f;
...
px_void PX_Object_PianoTune_position_hammerOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                     px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_mult_loss_filterOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                      px_void *ptr)
{
    px_float fvalue;
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, (PX_Object *)ptr);
...
px_void PX_Object_PianoTune_hammer_typeOnChanged(PX_Object *pObject, PX_Object_Event e,
                                                 px_void *ptr)
{
...
PX_Object *PX_Object_PianoTuneCreate(px_memorypool *mp, PX_Object *Parent, px_float x, px_float y,
                                     px_float _width, px_float height)
{
    PX_Object_PianoTune Tune, *pTune;
    PX_Object *pObject;
    px_int width = (px_int)_width;
    PX_memset(&Tune, 0, sizeof(Tune));
    pObject = PX_ObjectCreateEx(mp, Parent, x, y, 0, _width, height, 0, PX_OBJECT_TYPE_PIANOTUNE,
                                PX_NULL, PX_Object_PianoTuneOnRender, PX_NULL, &Tune, sizeof(Tune));
    ...
    pTune->label_f = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24, "frequency:",
                                           PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_f = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
    ...
    PX_ObjectRegisterEvent(pTune->sliderbar_f, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_fOnChanged, pObject);

    pTune->label_weight = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                "Key pulsation velocity weight:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_weight = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                        PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_weight, 0, 1000);
    PX_ObjectRegisterEvent(pTune->sliderbar_weight, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_weightOnChanged, pObject);

    pTune->label_minr = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                              "minimum string radio:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_minr = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                      PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_minr, 0, 1000);//0.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_minr, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_minrOnChanged, pObject);

    pTune->label_maxr = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                              "maximum string radio:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_maxr = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                      PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_maxr, 0, 1000);//0.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_maxr, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_maxrOnChanged, pObject);

    pTune->label_amprl = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                               "radius left sigmoidal shape:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_amprl = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                       PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_amprl, 0, 1000);//0.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_amprl, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_amprlOnChanged, pObject);

    pTune->label_amprr = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                               "radius right sigmoidal shape:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_amprr = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                       PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_amprr, 0, 1000);//0.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_amprr, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_amprrOnChanged, pObject);

    pTune->label_mult_radius_core_string = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                                 "cord nucleus radio:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_radius_core_string = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0,
                                                                         width, 24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_radius_core_string, 0, 2000);//0.000-2.000
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_radius_core_string, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_radius_core_stringOnChanged, pObject);

    pTune->label_minL = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                              "minimum string length:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_minL = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                      PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_minL, 0, 1000);//0.000-0.1000
    PX_ObjectRegisterEvent(pTune->sliderbar_minL, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_minLOnChanged, pObject);

    pTune->label_maxL = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                              "maximum string length.:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_maxL = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                      PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_maxL, 0, 1000);//00.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_maxL, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_maxLOnChanged, pObject);

    pTune->label_ampLl = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                               "length left sigmoidal shape:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_ampLl = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                       PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_ampLl, 0, 1000);//-10-0
    PX_ObjectRegisterEvent(pTune->sliderbar_ampLl, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_ampLlOnChanged, pObject);

    pTune->label_ampLr = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                               "length right sigmoidal shape:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_ampLr = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                       PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_ampLr, 0, 1000);//0-10
    PX_ObjectRegisterEvent(pTune->sliderbar_ampLr, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_ampLrOnChanged, pObject);

    pTune->label_mult_density_string = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                             "string density:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_density_string = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width,
                                                                     24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_density_string, 0, 1000);//00.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_density_string, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_density_stringOnChanged, pObject);

    pTune->label_mult_modulus_string = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                             "young modulus:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_modulus_string = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width,
                                                                     24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_modulus_string, 0, 1000);//00.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_modulus_string, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_modulus_stringOnChanged, pObject);

    pTune->label_mult_impedance_bridge = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                               "bridge impedance:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_impedance_bridge = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0,
                                                                       width, 24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_impedance_bridge, 0, 1000);//00.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_impedance_bridge, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_impedance_bridgeOnChanged, pObject);

    pTune->label_mult_impedance_hammer = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                               "hammer impedance:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_impedance_hammer = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0,
                                                                       width, 24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_impedance_hammer, 0, 1000);//00.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_impedance_hammer, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_impedance_hammerOnChanged, pObject);

    pTune->label_mult_mass_hammer = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                          "mass hammer:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_mass_hammer = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width,
                                                                  24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_mass_hammer, 0, 1000);//00.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_mass_hammer, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_mass_hammerOnChanged, pObject);

    pTune->label_mult_force_hammer = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                           "force hammer:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_force_hammer = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width,
                                                                   24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_mass_hammer, 0, 1000);//0.000-1.000
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_force_hammer, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_force_hammerOnChanged, pObject);

    pTune->label_mult_hysteresis_hammer = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                                "hysteresys hammer:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_hysteresis_hammer = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0,
                                                                        width, 24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_hysteresis_hammer, 0, 1000);//00.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_hysteresis_hammer, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_hysteresis_hammerOnChanged, pObject);

    pTune->label_mult_stiffness_exponent_hammer = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0,
                                                                        width, 24, "stiffness exponent hammer:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_stiffness_exponent_hammer = PX_Object_SliderBarCreate(mp, pTune->scrollArea,
                                                                                0, 0, width, 24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_stiffness_exponent_hammer, 0, 1000);//00.00-10.00
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_stiffness_exponent_hammer,
                           PX_OBJECT_EVENT_VALUECHANGED, PX_Object_PianoTune_mult_stiffness_exponent_hammerOnChanged, pObject);

    pTune->label_position_hammer = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                         "position hammer:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_position_hammer = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                                 PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_position_hammer, 0, 1000);//00.00-1.000
    PX_ObjectRegisterEvent(pTune->sliderbar_position_hammer, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_position_hammerOnChanged, pObject);


    pTune->label_mult_loss_filter = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                          "string loss factor:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_mult_loss_filter = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width,
                                                                  24, PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_mult_loss_filter, 0, 1000);//0.0003
    PX_ObjectRegisterEvent(pTune->sliderbar_mult_loss_filter, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_mult_loss_filterOnChanged, pObject);

    pTune->label_detune = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                "detuning among 3 strings:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_detune = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                        PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_detune, 0, 1000);//0.00000-0.001000
    PX_ObjectRegisterEvent(pTune->sliderbar_detune, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_detuneOnChanged, pObject);

    pTune->label_hammer_type = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                     "hammer type:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->selectbox_hammer_type = PX_Object_SelectBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                             PX_NULL);
    ...
    PX_ObjectRegisterEvent(pTune->selectbox_hammer_type, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_hammer_typeOnChanged, pObject);

    pTune->label_eq1 = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                             "global:soundboard eq1:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_eq1 = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                     PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_eq1, 0, 1000);
    PX_ObjectRegisterEvent(pTune->sliderbar_eq1, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_eq1OnChanged, pObject);

    pTune->label_eq2 = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                             "global:soundboard eq2:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_eq2 = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                     PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_eq2, 0, 1000);
    PX_ObjectRegisterEvent(pTune->sliderbar_eq2, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_eq2OnChanged, pObject);

    pTune->label_eq3 = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                             "global:soundboard eq3:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_eq3 = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                     PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_eq3, 0, 1000);
    PX_ObjectRegisterEvent(pTune->sliderbar_eq3, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_eq3OnChanged, pObject);

    pTune->label_c1 = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                            "global:soundboard c1:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_c1 = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                    PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_c1, 0, 1000);
    PX_ObjectRegisterEvent(pTune->sliderbar_c1, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_c1OnChanged, pObject);

    pTune->label_c3 = PX_Object_LabelCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                            "global:soundboard c3:", PX_NULL, PX_OBJECT_UI_DEFAULT_FONTCOLOR);
    pTune->sliderbar_c3 = PX_Object_SliderBarCreate(mp, pTune->scrollArea, 0, 0, width, 24,
                                                    PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);
    PX_Object_SliderBarSetRange(pTune->sliderbar_c3, 0, 1000);
    PX_ObjectRegisterEvent(pTune->sliderbar_c3, PX_OBJECT_EVENT_VALUECHANGED,
                           PX_Object_PianoTune_c3OnChanged, pObject);
    return pObject;
}


px_void PX_Object_PianoTuneSetParametersEx(PX_Object *pObject, PX_PianoKey_Parameters param,
                                           PX_PianoSoundboard_Parameters sParam)
{
    PX_Object_PianoTune *pTune = PX_ObjectGetDesc(PX_Object_PianoTune, pObject);
...
//Piano
/////////////////////////////////////////////////////////
PX_Object *PX_Designer_PianoCreate(px_memorypool *mp, PX_Object *pparent, px_float x, px_float y,
