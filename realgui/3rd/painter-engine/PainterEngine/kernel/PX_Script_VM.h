...
px_bool             PX_VMCallFunction(PX_VM *Ins, px_int threadID, const px_char *functionName,
                                      PX_VM_VARIABLE args[], px_int paramcount);
px_bool             PX_VMRunFunctionIndex(PX_VM *Ins, px_int threadID, px_int funcIndex,
                                          PX_VM_VARIABLE args[], px_int paramcount);
px_int              PX_VMGetFreeThread(PX_VM *Ins, px_int reservedThread);
px_bool             PX_VMBeginThreadFunction(PX_VM *Ins, px_int threadID,
                                             const px_char *functionName, PX_VM_VARIABLE args[], px_int paramcount);
...
px_bool             PX_VMDebuggerGetVarParamName(PX_VM *Ins, px_char optype, px_int param,
                                                 px_char content[], px_int size);
px_void             PX_VMDebuggerGetParamName(PX_VM *Ins, px_char optype, px_int param,
                                              px_char content[], px_int size);
px_int              PX_VMDebuggerInstruction(PX_VM *Ins, px_int IP, px_char *opcode,
                                             px_char opcode_name[16], px_int *paramCount, px_char opType[3], px_int param[3]);
#endif
