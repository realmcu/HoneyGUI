...
typedef struct
{
    ...
    PX_Object *label_mult_radius_core_string,
              * sliderbar_mult_radius_core_string;//1 cord nucleus radio.
    ...
    PX_Object *label_mult_stiffness_exponent_hammer,
              *sliderbar_mult_stiffness_exponent_hammer;//1  stiffness_exponent_hammer.
