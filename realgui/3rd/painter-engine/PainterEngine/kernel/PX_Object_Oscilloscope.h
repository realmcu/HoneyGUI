...
px_void PX_Object_OscilloscopeSetLineMode(PX_Object *pObject, PX_OBJECT_OSCILLOSCOPE_LINEMODE mode,
                                          px_float width);
...
px_void PX_Object_OscilloscopeSetFloatFlagFormatVerticalLeft(PX_Object *pObject,
                                                             const px_char *fmt);
...
px_void PX_Object_OscilloscopeAddOscilloscopeFlagLine(PX_Object *pObject,
