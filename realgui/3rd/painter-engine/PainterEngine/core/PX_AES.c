...
static px_bool                  PX_AES_i_Cipher(PX_AES *aesStruct,
                                                AES_BYTE input[PX_AES_BLOCK_BYTES_SIZE],
                                                AES_BYTE output[PX_AES_BLOCK_BYTES_SIZE]) /* encipher 16-bit input */;
static px_void                  PX_AES_i_InvCipher(PX_AES *aesStruct,
                                                   AES_BYTE input[PX_AES_BLOCK_BYTES_SIZE],
                                                   AES_BYTE output[PX_AES_BLOCK_BYTES_SIZE]) /* decipher 16-bit input */;
...
px_void PX_AES_AddRoundKey(PX_AES *aesStruct, px_int round)
{
    ...
    for (r = 0; r < 4; ++r)
    {
        for (c = 0; c < 4; ++c)
        {
            aesStruct->State[r][c] = (AES_BYTE)((px_int)aesStruct->State[r][c] ^ (px_int)aesStruct->w[(round *
                                                4) + c][r]);
        }
    }
}
...
static px_bool PX_AES_i_Cipher(PX_AES *aesStruct, AES_BYTE input[PX_AES_BLOCK_BYTES_SIZE],
                               AES_BYTE output[PX_AES_BLOCK_BYTES_SIZE])  // encipher 16-bit input
{
    px_int i, round;
...
px_bool PX_AES_Cipher(PX_AES *aesStruct, px_byte input[16],
                      px_byte output[16]) /* encipher 16-bit input */
{
...
px_void PX_AES_MixColumns(PX_AES *aesStruct)
{
    ...
    for (c = 0; c < 4; ++c)
    {
        aesStruct->State[0][c] = (AES_BYTE)((px_int)PX_AES_gfmultby02(temp[0][c]) ^
                                            (px_int)PX_AES_gfmultby03(temp[1][c]) ^
                                            (px_int)PX_AES_gfmultby01(temp[2][c]) ^ (px_int)PX_AES_gfmultby01(temp[3][c]));
        aesStruct->State[1][c] = (AES_BYTE)((px_int)PX_AES_gfmultby01(temp[0][c]) ^
                                            (px_int)PX_AES_gfmultby02(temp[1][c]) ^
                                            (px_int)PX_AES_gfmultby03(temp[2][c]) ^ (px_int)PX_AES_gfmultby01(temp[3][c]));
        aesStruct->State[2][c] = (AES_BYTE)((px_int)PX_AES_gfmultby01(temp[0][c]) ^
                                            (px_int)PX_AES_gfmultby01(temp[1][c]) ^
                                            (px_int)PX_AES_gfmultby02(temp[2][c]) ^ (px_int)PX_AES_gfmultby03(temp[3][c]));
        aesStruct->State[3][c] = (AES_BYTE)((px_int)PX_AES_gfmultby03(temp[0][c]) ^
                                            (px_int)PX_AES_gfmultby01(temp[1][c]) ^
...
px_void PX_AES_InvMixColumns(PX_AES *aesStruct)
{
    ...
    for (c = 0; c < 4; ++c)
    {
        aesStruct->State[0][c] = (AES_BYTE)((px_int)PX_AES_gfmultby0e(temp[0][c]) ^
                                            (px_int)PX_AES_gfmultby0b(temp[1][c]) ^
                                            (px_int)PX_AES_gfmultby0d(temp[2][c]) ^ (px_int)PX_AES_gfmultby09(temp[3][c]));
        aesStruct->State[1][c] = (AES_BYTE)((px_int)PX_AES_gfmultby09(temp[0][c]) ^
                                            (px_int)PX_AES_gfmultby0e(temp[1][c]) ^
                                            (px_int)PX_AES_gfmultby0b(temp[2][c]) ^ (px_int)PX_AES_gfmultby0d(temp[3][c]));
        aesStruct->State[2][c] = (AES_BYTE)((px_int)PX_AES_gfmultby0d(temp[0][c]) ^
                                            (px_int)PX_AES_gfmultby09(temp[1][c]) ^
                                            (px_int)PX_AES_gfmultby0e(temp[2][c]) ^ (px_int)PX_AES_gfmultby0b(temp[3][c]));
        aesStruct->State[3][c] = (AES_BYTE)((px_int)PX_AES_gfmultby0b(temp[0][c]) ^
                                            (px_int)PX_AES_gfmultby0d(temp[1][c]) ^
                                            (px_int)PX_AES_gfmultby09(temp[2][c]) ^ (px_int)PX_AES_gfmultby0e(temp[3][c]));
    }
}  // InvMixColumns

static px_void PX_AES_i_InvCipher(PX_AES *aesStruct, AES_BYTE input[PX_AES_BLOCK_BYTES_SIZE],
                                  AES_BYTE output[PX_AES_BLOCK_BYTES_SIZE])  // decipher 16-bit input
{
    px_int i, round;
...
px_void PX_AES_InvCipher(PX_AES *aesStruct, px_byte input[16],
                         px_byte output[16]) /* decipher 16-bit input */
{
