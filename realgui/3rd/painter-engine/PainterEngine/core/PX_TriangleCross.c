...
static px_int px_triangle_segments_intersert(px_point2D p1, px_point2D p2, px_point2D p3,
                                             px_point2D p4)
{
...
static px_bool px_triangle_line_triangle_intersert_inSamePlane(px_triangle *tri, px_point f1,
                                                               px_point f2)
{
...
static px_bool px_triangle_intersert_inSamePlane(px_triangle *tri1, px_triangle *tri2)
{
    ...
    else
    {
        ...
        if (px_triangle_is_point_within_triangle(tri2, centralPoint1) ||
            px_triangle_is_point_within_triangle(tri1, centralPoint2))
        {
            return PX_TRUE;
        }
...
{
    px_float p1_tri2_vertex1 = px_triangleget_vector4_det(tri1->Vertex_1, tri1->Vertex_2,
                                                          tri1->Vertex_3, tri2->Vertex_1);

    px_float p1_tri2_vertex2 = px_triangleget_vector4_det(tri1->Vertex_1, tri1->Vertex_2,
                                                          tri1->Vertex_3, tri2->Vertex_2);

    px_float p1_tri2_vertex3 = px_triangleget_vector4_det(tri1->Vertex_1, tri1->Vertex_2,
                                                          tri1->Vertex_3, tri2->Vertex_3);
    ...
    p2_tri1_vertex1 = px_triangleget_vector4_det(tri2->Vertex_1, tri2->Vertex_2, tri2->Vertex_3,
                                                 tri1->Vertex_1);

    p2_tri1_vertex2 = px_triangleget_vector4_det(tri2->Vertex_1, tri2->Vertex_2, tri2->Vertex_3,
                                                 tri1->Vertex_2);

    p2_tri1_vertex3 = px_triangleget_vector4_det(tri2->Vertex_1, tri2->Vertex_2, tri2->Vertex_3,
                                                 tri1->Vertex_3);
    ...
    if (px_triangleget_vector4_det(tri1_a, tri1_b, tri2_a, tri2_b) <= 0 &&
        px_triangleget_vector4_det(tri1_a, tri1_c, tri2_c, tri2_a) <= 0)
    {
        return PX_TRUE;
    }
    else
