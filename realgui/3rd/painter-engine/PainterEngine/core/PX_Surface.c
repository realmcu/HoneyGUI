...
px_void PX_SurfaceSetLimit(px_surface *ps, px_int limit_left, px_int limit_top, px_int limit_right,
                           px_int limit_bottom)
{
...
{
    if (X <= psurface->limit_right && X >= psurface->limit_left && Y <= psurface->limit_bottom &&
...
px_void PX_SurfaceClear(px_surface *psurface, px_int left, px_int top, px_int right, px_int bottom,
                        px_color color)
{
    px_int i, mid;
