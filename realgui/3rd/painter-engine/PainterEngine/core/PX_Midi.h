...
typedef px_void(*PX_MidiCallback)(struct _PX_Midi *midi, px_byte opcode, px_byte  track,
                                  px_byte  instrument, px_byte Note, px_byte velocity, px_void *userptr);
...
px_bool PX_MidiInitialize(PX_Midi *pmidi, px_memorypool *mp, PX_MidiCallback callback,
                          px_void *userptr);
