...
template <typename PathIterator1T, typename PathIterator2T>
joined_path<PathIterator1T, PathIterator2T> join(const PathIterator1T &path1,
                                                 const PathIterator2T &path2)
...
template <typename SourceT, typename GeneratorT>
inline path_generator_adapter<SourceT, GeneratorT>::path_generator_adapter(const SourceT &source,
...
template <typename PathIterator1T, typename PathIterator2T>
inline joined_path<PathIterator1T, PathIterator2T>::joined_path(const PathIterator1T &path1,
                                                                const PathIterator2T &path2)
