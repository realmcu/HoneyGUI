...
namespace joins
{
void bevel::calc(points &output, real_t w, const point_r &v0, real_t d01, const point_r &v1,
...
void get_lines_midpoint(const point_r &v0, real_t d01, const point_r &v1, real_t d12,
                        const point_r &v2, float &m_x, float &m_y)
{
...
void round::calc(points &output, real_t w, const point_r &v0, real_t d01, const point_r &v1,
                 real_t d12, const point_r &v2) const
{
...
float get_new_edge_point(const point_r &v0, const point_r &v1, const point_r &v2, float m_x,
                         float m_y, float x1, float y1, float w, float &x, float &y, bool &is_h)
{
    float A = 0.0f;
    float B = 0.0f;
    float k = 0.0f;
...
void miter::calc(points &output, real_t w, const point_r &v0, real_t d01, const point_r &v1,
                 real_t d12, const point_r &v2) const
{
    const real_t d01_w = w / d01;
    const real_t d12_w = w / d12;
