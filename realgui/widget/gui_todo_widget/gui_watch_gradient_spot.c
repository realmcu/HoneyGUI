...
static void gui_watch_gradient_spot_draw(gui_watch_gradient_spot_t *this, NVGcontext *vg)
{
...
static void gui_watch_gradient_spot_destroy(gui_obj_t *obj)
{

}

static void gui_watch_gradient_spot_cb(gui_obj_t *obj, T_OBJ_CB_TYPE cb_type)
{
    if (obj != NULL)
    {
        switch (cb_type)
        ...
        case OBJ_DESTROY:
            gui_watch_gradient_spot_destroy(obj);
            break;
