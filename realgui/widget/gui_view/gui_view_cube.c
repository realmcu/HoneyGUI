...
void gui_view_cube(gui_view_t *this, int16_t release)
{
    ...
    if (this->current_transition_style == SWITCH_IN_FROM_LEFT_USE_CUBE)
    {
        offset_x = release - w;
    }
    else if (this->current_transition_style == SWITCH_IN_FROM_RIGHT_USE_CUBE)
    {
        offset_x = release + w;
    }
    else if (this->current_transition_style == SWITCH_IN_FROM_TOP_USE_CUBE)
    {
        offset_y = release - h;
    }
    else if (this->current_transition_style == SWITCH_IN_FROM_BOTTOM_USE_CUBE)
    {
        offset_y = release + h;
    }
    else if (this->current_transition_style == SWITCH_OUT_TO_LEFT_USE_CUBE ||
             this->current_transition_style == SWITCH_OUT_TO_RIGHT_USE_CUBE)
    {
        offset_x = release;
    }
    else
    ...
    rotate_degree_x = 90 * offset_y / (this->base.h);
    rotate_degree_y = 90 * offset_x / (this->base.w);
