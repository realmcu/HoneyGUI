...
GUI_APP_ENTRY(APP_WEB)
{
    ...
    gui_web_open_html("realgui\\example\\web\\mechanical-clock-canvas\\index.html",
                      GUI_APP_ROOT_SCREEN);
...
GUI_APP_ENTRY(APP_CALENDAR)
{
    ...
    create_tree_nest("realgui\\example\\screen_454_454\\root_image\\root\\stop_watch\\calnedar.xml",
                     GUI_APP_ROOT_SCREEN);
#else
