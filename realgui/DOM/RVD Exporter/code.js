    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        frames.forEach((frame, index) => {
            ...
            if (frame.reactions && frame.reactions.length > 0) {
                ...
                if (((_a = reaction.trigger) === null || _a === void 0 ? void 0 : _a.type) === "ON_CLICK" &&
                    ((_b = reaction.action) === null || _b === void 0 ? void 0 : _b.type) === "NODE" &&
            ...
            const rectangles = frame.findAll((node) => node.type === "RECTANGLE");
        ...
        xml += `    </screen>\n`;
        xml += `</app>`;
        const images = yield Promise.all(Array.from(imageSet).map((hash) => __awaiter(this, void 0, void 0, function* () {
