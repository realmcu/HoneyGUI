 ...
 *                            Macros
 *============================================================================*/
#define CURRENT_VIEW_NAME "case_menu_view"
 ...
 *============================================================================*/
static void case_menu_view_design(gui_view_t *view);
...
static gui_view_descriptor_t const descriptor =
{
    ...
    .pView = &current_view,
    .on_switch_in = case_menu_view_design,
    .on_switch_out = clear,
};
...
static void note_design(gui_obj_t *obj, void *p)
{
    ...
    if (theme_bg_white)
    {
        gui_img_set_a8_fg_color(img, FG_THEME3_LIGHT.color.argb_full);
        font_color = FG_1_LIGHT;
    }
    else
    {
        gui_img_set_a8_fg_color(img, FG_THEME3_DARK.color.argb_full);
