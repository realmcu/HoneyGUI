...
void switch_dynamic_island(void *obj, gui_event_t e)
{
    ...
    {
        dynamic_island_rect = gui_img_create_from_mem(dynamic_island, "dynamic_island_rect1",
    ...
    else if (dynamic_island_count == 2)
    {
        ...
        // gui_img_t *dynamic_islcand_pic1 = gui_img_create_from_mem(dynamic_island_rect, "dynamic_islcand_pic1",
        //                                                     DYNAMIC_ISLAND_MUSIC_BIN, 10, 10, 0, 0);
        // gui_img_t *dynamic_islcand_pic2 = gui_img_create_from_mem(dynamic_island_rect, "dynamic_islcand_pic2",
    ...
    else if (dynamic_island_count == 6)
    {
        ...
        gui_img_t *dynamic_islcand_pic2 = gui_img_create_from_mem(dynamic_island_rect,
                                                                  "dynamic_island_rect_pic2",
                                                                  DYNAMIC_ISLAND_BPM_ICON_BIN, 82, 12, 0, 0);
        gui_img_t *dynamic_islcand_pic3 = gui_img_create_from_mem(dynamic_island_rect,
                                                                  "dynamic_island_rect_pic3",
                                                                  DYNAMIC_ISLAND_BPM_NUM_BIN, 112, 14, 0, 0);
        gui_img_t *dynamic_islcand_pic4 = gui_img_create_from_mem(dynamic_island_rect,
                                                                  "dynamic_island_rect_pic4",
                                                                  DYNAMIC_ISLAND_BPM_BIN, 146, 14, 0, 0);
        gui_img_t *dynamic_islcand_pic5 = gui_img_create_from_mem(dynamic_island_rect,
                                                                  "dynamic_island_rect_pic5",
                                                                  DYNAMIC_ISLAND_STEPS_ICON_BIN, 82, 40, 0, 0);
        gui_img_t *dynamic_islcand_pic6 = gui_img_create_from_mem(dynamic_island_rect,
                                                                  "dynamic_island_rect_pic6",
                                                                  DYNAMIC_ISLAND_STEPS_NUM_BIN, 112, 40, 0, 0);
        gui_img_t *dynamic_islcand_pic7 = gui_img_create_from_mem(dynamic_island_rect,
...
void design_tab_home(void *parent)
{
    ...
    gui_obj_add_event_cb(dynamic_island, (gui_event_cb_t)enter_app_set_start, GUI_EVENT_TOUCH_CLICKED,
                         NULL);
    gui_img_set_animate(second, 100000, 0xffffffff, turn, NULL);
