...
static void click_speaker_cb(void *obj, gui_event_t *e)
{
    ...
    bool status = true;
    if (img->src_data == SPEAKER_ON_ICON_BIN)
    {
        img->src_data = SPEAKER_OFF_ICON_BIN;
        status = false;
    }
    else
    {
        img->src_data = SPEAKER_ON_ICON_BIN;
    }
...
static void click_mic_cb(void *obj, gui_event_t *e)
{
    ...
    gui_call_t *call = gui_get_call();
    bool status = true;
    if (img->src_data == MIC_ON_ICON_BIN)
    {
        img->src_data = MIC_OFF_ICON_BIN;
        status = false;
    }
    else
    {
        img->src_data = MIC_ON_ICON_BIN;
    }
