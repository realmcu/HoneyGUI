...
static void phone_change_state()
{
    if (sw_state.sw_3)
    {
...
static void nobother_change_state()
{
    if (sw_state.sw_5)
    {
...
static void switch_cb(void *obj, gui_event_t e, void *param)
{
    ...
    else if (strcmp(img->base.name, "sw_phone") == 0)
    {
        ...
        if (sw_state.sw_3)
        {
            ...
            gui_img_set_image_data(img_phone, PHONE_ON_ICON_BIN);
        }
        else
        {
            gui_img_set_image_data(img, CONTROL_PHONE_OFF_BIN);
            gui_img_set_image_data(img_phone, PHONE_OFF_ICON_BIN);
        }
    }
    else if (strcmp(img->base.name, "sw_mute") == 0)
    {
        ...
        if (sw_state.sw_4)
        {
            ...
            gui_img_set_image_data(img_mute, MUTE_ON_ICON_BIN);
        }
        else
        {
            gui_img_set_image_data(img, CONTROL_MUTE_OFF_BIN);
            gui_img_set_image_data(img_mute, MUTE_OFF_ICON_BIN);
        }
    }
    else if (strcmp(img->base.name, "sw_nobother") == 0)
    {
        ...
        if (sw_state.sw_5)
        {
            ...
            gui_img_set_image_data(img_nobother, NOBOTHER_ON_ICON_BIN);
        }
        else
        {
            gui_img_set_image_data(img, CONTROL_NOBOTHER_OFF_BIN);
            gui_img_set_image_data(img_nobother, NOBOTHER_OFF_ICON_BIN);
        }
    }
}
