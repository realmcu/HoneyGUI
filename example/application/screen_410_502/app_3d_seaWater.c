...
static void app_ui_wave_nums_design(gui_view_t *view)
{
    ...
    fish0 = gui_3d_create(fish_window, "3d-fish0", DESC_SEAFISH0_BIN, GUI_3D_DRAW_FRONT_ONLY, 0, 0,
                          410, 502);
    fish1 = gui_3d_create(fish_window, "3d-fish1", DESC_SEAFISH1_BIN, GUI_3D_DRAW_FRONT_ONLY, 0, 0,
                          410, 502);
    fish2 = gui_3d_create(fish_window, "3d-fish2", DESC_SEAFISH2_BIN, GUI_3D_DRAW_FRONT_ONLY, 0, 0,
                          410, 502);
    fish3 = gui_3d_create(fish_window, "3d-fish3", DESC_SEAFISH3_BIN, GUI_3D_DRAW_FRONT_ONLY, 0, 0,
                          410, 502);
    ...
    can0 = gui_img_create_from_mem(can0_window, "can0", CANSKIN_PURPLE_BIN, 0, 0, 0, 0);
    ...
    can1 = gui_img_create_from_mem(can1_window, "can1", CANSKIN_YELLOW_BIN, 0, 0, 0, 0);
    ...
    can2 = gui_img_create_from_mem(can2_window, "can2", CANSKIN_GREEN_BIN, 0, 0, 0, 0);
    ...
    can3 = gui_img_create_from_mem(can3_window, "can3", CANSKIN_RED_BIN, 0, 0, 0, 0);
