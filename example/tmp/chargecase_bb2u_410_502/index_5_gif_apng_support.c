...
static uint32_t *gui_switch_array[28] = {0};
...
static void gif_apng_support_switch_in(gui_view_t *view)
{
    ...
    if (gui_switch_array[0] == NULL)
    {
        uint32_t *switch_array[] =
        {
            FRAME_0024_BIN,
            FRAME_0025_BIN,
            FRAME_0026_BIN,
        ...
        memcpy(gui_switch_array, switch_array, sizeof(switch_array));
    }
    {
        gui_img_t *switch_widget =
            gui_img_create_from_mem(view,
                                    0, FRAME_0024_BIN, 150, 50, 0, 0);
...
static void switch_widget_play(void *p)
{
    ...
    int array_size = ARRAY_SIZE(gui_switch_array);
