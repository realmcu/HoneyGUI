...
static void anti_aliasing_switch_in(gui_view_t *view)
{
...

    {
        ...
        gui_text_type_set(text, ALFASLABONEREGULAR_SIZE110_BITS4_FONT_BIN,
                          FONT_SRC_MEMADDR);
    ...
    }
    {
        ...
        gui_text_set(text, "THEQUICK", GUI_FONT_SRC_BMP, gui_color_css("white"), strlen("THEQUICK"), 110);
        gui_text_type_set(text, MOMOSIGNATUREREGULAR_SIZE110_BITS4_FONT_BIN,
                          FONT_SRC_MEMADDR);
        gui_text_mode_set(text, LEFT);
    }
    {
        ...
        gui_text_type_set(text, ALFASLABONEREGULAR_SIZE12_BITS4_FONT_BIN,
                          FONT_SRC_MEMADDR);
        gui_text_mode_set(text, LEFT);
    }
    {
        ...
        gui_text_type_set(text, ALFASLABONEREGULAR_SIZE20_BITS4_FONT_BIN,
                          FONT_SRC_MEMADDR);
        gui_text_mode_set(text, LEFT);
    }
    {
        ...
        gui_text_type_set(text, ALFASLABONEREGULAR_SIZE32_BITS4_FONT_BIN,
                          FONT_SRC_MEMADDR);
        gui_text_mode_set(text, LEFT);
    }
    {
        ...
        gui_text_type_set(text, ALFASLABONEREGULAR_SIZE64_BITS4_FONT_BIN,
                          FONT_SRC_MEMADDR);
        gui_text_mode_set(text, LEFT);
    }
}
