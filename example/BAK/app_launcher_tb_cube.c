...
//     gui_cube_t *cube0 = gui_cube_create(parent, "cube", array, 0, 0);
//     gui_cube_set_size(cube0, 50);
//     gui_cube_set_center(cube0, 50, 50);

//     gui_cube_t *cube1 = gui_cube_create(parent, "cube", array, 0, 0);
//     gui_cube_set_size(cube1, 50);
//     gui_cube_set_center(cube1, 350, 350);

//     gui_cube_t *cube2 = gui_cube_create(parent, "cube", array, 0, 0);
//     gui_cube_set_size(cube2, 50);
//     gui_cube_set_center(cube2, 50, 350);

//     gui_cube_t *cube3 = gui_cube_create(parent, "cube", array, 0, 0);
//     gui_cube_set_size(cube3, 50);
//     gui_cube_set_center(cube3, 350, 50);

//     gui_cube_t *cube4 = gui_cube_create(parent, "cube", array, 0, 0);
