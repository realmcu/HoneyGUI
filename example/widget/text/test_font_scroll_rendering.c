...
static void ui_text_font(gui_view_t *view)
{
    ...
    gui_scroll_text_set(scroll_text1, (void *)CURRENT_VIEW_NAME, GUI_FONT_SRC_BMP, APP_COLOR_WHITE,
    ...
    gui_scroll_text_set(scroll_text2, (void *)CURRENT_VIEW_NAME, GUI_FONT_SRC_BMP, APP_COLOR_WHITE,
                        strlen(CURRENT_VIEW_NAME), font_size);
    ...
    gui_scroll_text_set(scroll_text3, (void *)CURRENT_VIEW_NAME, GUI_FONT_SRC_BMP, APP_COLOR_WHITE,
                        strlen(CURRENT_VIEW_NAME), font_size);
    ...
    gui_scroll_text_set(scroll_text4, (void *)CURRENT_VIEW_NAME, GUI_FONT_SRC_BMP, APP_COLOR_WHITE,
                        strlen(CURRENT_VIEW_NAME), font_size);
    ...
    gui_scroll_text_set(scroll_text5, (void *)CURRENT_VIEW_NAME, GUI_FONT_SRC_TTF, APP_COLOR_WHITE,
                        strlen(CURRENT_VIEW_NAME), font_size);
    ...
    gui_text_set(test_name, (void *)CURRENT_VIEW_NAME, GUI_FONT_SRC_BMP, APP_COLOR_WHITE,
                 strlen(CURRENT_VIEW_NAME), font_size);
