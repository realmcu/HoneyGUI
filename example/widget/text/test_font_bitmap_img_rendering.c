...
*****************************************************************************************
  * @file test_font_bitmap_img_rendering.c
...
static void ui_text_font(gui_view_t *view)
{
    ...
    GUI_FormatType cf[4] = {RGB565, ARGB8565, ARGB8565, ARGB8888};
    struct gui_dispdev *dc = gui_get_dc();
    uint32_t font_size = 32;
    for (int i = 0; i < FONT_NUM - 3; i++)/*todobyluke*/
    {
    ...
    for (int i = 0 + 1; i < FONT_NUM; i++)/*todobyluke*/
    {
