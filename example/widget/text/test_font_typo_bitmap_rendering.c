 ...
 *                            Macros
 *============================================================================*/
#define CURRENT_VIEW_NAME "test_font_typo_bitmap_rendering"
...
{
    right_view = gui_view_descriptor_get("test_font_typo_vector_rendering");
    return 0;
}
