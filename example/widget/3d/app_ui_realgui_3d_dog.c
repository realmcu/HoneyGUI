...
{
    void *dog_3d = gui_3d_create(gui_obj_get_root(), "3d-widget", (void *)_acdesc, 0, 0, 480, 480);

    gui_3d_set_global_shape_transform_cb(dog_3d, (gui_3d_shape_transform_cb)dog_cb);

    gui_obj_create_timer(&(((gui_3d_base_t *)dog_3d)->base), 17, true, update_dog_animation);
    gui_obj_start_timer(&(((gui_3d_base_t *)dog_3d)->base));
