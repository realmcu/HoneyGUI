...
#include "tp_algo.h"
#include "flag_gltf/gltf_desc.txt"
...
static int app_init(void)
{
    ...
    l3_gltf_model_t *flag_3d = l3_create_gltf_model((void *)_acgltf_desc, LITE_RGB565, 0, 0,
                                                    dc->screen_width,
                                                    dc->screen_height);

    l3_gltf_set_global_transform(flag_3d, (l3_gltf_global_transform_cb)flag_global_cb);

    gui_lite3d_gltf_t *lite3d_flag = gui_lite3d_gltf_create(gui_obj_get_root(), "lite3d-widget",
                                                            flag_3d, 0, 0, 0, 0);
