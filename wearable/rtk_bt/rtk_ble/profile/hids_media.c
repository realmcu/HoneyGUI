...
/**
  ...
  * \endcode
  */
static T_SERVER_ID hid_service_id;
...
{
    //uint8_t keyboard_data[8] = {0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00};
    uint8_t keyboard_data[3] = {0x80, 0x00, 0x00};
    hids_send_report(0, hid_service_id, GATT_SVC_HID_MM_IN_REPORT_INDEX,
                     keyboard_data, sizeof(keyboard_data));
    memset(keyboard_data, 0x00, sizeof(keyboard_data));
    hids_send_report(0, hid_service_id, GATT_SVC_HID_MM_IN_REPORT_INDEX,
                     keyboard_data, sizeof(keyboard_data));
}


MSH_CMD_EXPORT(hid_test, test test test);
