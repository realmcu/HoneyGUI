...
void tuya_ble_handle_dp_data_reported_evt(tuya_ble_evt_param_t *evt)
{
    ...
    tuya_ble_commData_send(FRM_STAT_REPORT, 0, evt->reported_data.p_data, evt->reported_data.data_len,
                           encry_mode);
...
void tuya_ble_handle_dp_data_with_flag_reported_evt(tuya_ble_evt_param_t *evt)
{
    ...
    tuya_ble_commData_send(FRM_DATA_WITH_FLAG_REPORT, 0, evt->flag_reported_data.p_data,
                           evt->flag_reported_data.data_len, encry_mode);
...
void tuya_ble_handle_dp_data_with_flag_and_time_reported_evt(tuya_ble_evt_param_t *evt)
{
    ...
    memcpy(&data_buffer[8], evt->flag_reported_with_time_data.p_data,
           evt->flag_reported_with_time_data.data_len);
...
void tuya_ble_handle_dp_data_with_time_string_reported_evt(tuya_ble_evt_param_t *evt)
{
    ...
    memcpy(&data_buffer[14], evt->reported_with_time_string_data.p_data,
           evt->reported_with_time_string_data.data_len);
...
void tuya_ble_handle_dp_data_with_flag_and_time_string_reported_evt(tuya_ble_evt_param_t *evt)
{
    ...
    memcpy(&data_buffer[17], evt->flag_reported_with_time_string_data.p_data,
           evt->flag_reported_with_time_string_data.data_len);
...
void tuya_ble_handle_dp_data_send_evt(tuya_ble_evt_param_t *evt)
{
    ...
    tuya_ble_commData_send(FRM_DP_DATA_SEND_REQ, 0, evt->dp_send_data.p_data,
                           evt->dp_send_data.data_len, encry_mode);
...
void tuya_ble_handle_dp_data_with_time_send_evt(tuya_ble_evt_param_t *evt)
{
    ...
    tuya_ble_commData_send(FRM_DP_DATA_WITH_TIME_SEND_REQ, 0, evt->dp_with_time_send_data.p_data,
                           evt->dp_with_time_send_data.data_len, encry_mode);
...
void tuya_ble_handle_ota_response_evt(tuya_ble_evt_param_t *evt)
{
    ...
    if (ota_cmd_type != 0)
    {
        tuya_ble_commData_send(ota_cmd_type, 0, evt->ota_response_data.p_data,
                               evt->ota_response_data.data_len, encry_mode);
    }
...
void tuya_ble_handle_data_passthrough_evt(tuya_ble_evt_param_t *evt)
{
    ...
    tuya_ble_commData_send(FRM_DATA_PASSTHROUGH_REQ, 0, evt->passthrough_data.p_data,
                           evt->passthrough_data.data_len, encry_mode);
...
void tuya_ble_handle_data_prod_test_response_evt(tuya_ble_evt_param_t *evt)
{
    ...
    else if (evt->prod_test_res_data.channel == 1)
    {
        ...
        tuya_ble_commData_send(FRM_FACTORY_TEST_RESP, 0, evt->prod_test_res_data.p_data,
                               evt->prod_test_res_data.data_len, encry_mode);
    }
...
void tuya_ble_handle_uart_cmd_evt(tuya_ble_evt_param_t *evt)
{
    ...
    TUYA_BLE_LOG_HEXDUMP_DEBUG("received uart cmd data", (uint8_t *)evt->uart_cmd_data.p_data,
                               evt->uart_cmd_data.data_len);//
    ...
    if (evt->uart_cmd_data.data_len > 0)
    {
        ...
        {
            TUYA_BLE_LOG_ERROR("uart receive data check_sum error , receive sum = 0x%02x ; cal sum = 0x%02x",
                               evt->uart_cmd_data.p_data[evt->uart_cmd_data.data_len - 1], sum);
        }
    }
...
void tuya_ble_handle_link_update_evt(tuya_ble_evt_param_t *evt)
{
    ...
    {
        if (LINK_ENCRYPTED_REQUEST == tuya_ble_link_status_get())
        {
            ...
            tuya_ble_commData_send(0x801D, 0, data, 2, encry_mode);
#endif
        }
        else
        {
