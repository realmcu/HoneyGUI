...
__TUYA_BLE_WEAK void tuya_ble_handle_dp_data_with_time_string_reported_evt(
...
__TUYA_BLE_WEAK void tuya_ble_handle_dp_data_with_flag_and_time_reported_evt(
    tuya_ble_evt_param_t *evt)
{

}

__TUYA_BLE_WEAK void tuya_ble_handle_dp_data_with_flag_and_time_string_reported_evt(
    tuya_ble_evt_param_t *evt)
{
