 ...
 *
 * */
extern tuya_ble_status_t tuya_ble_feature_weather_data_request(uint32_t combine_type,
                                                               uint8_t n_days);
 ...
 *
 * */
extern tuya_ble_status_t tuya_ble_feature_weather_data_request_with_location(
 ...
 *
 * */
extern tuya_ble_status_t tuya_ble_feature_weather_key_enum_type_to_string(
    tuya_ble_weather_key_type_t type, char *key);
