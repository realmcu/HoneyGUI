...
tuya_ble_status_t tuya_ble_gap_advertising_adv_data_update(uint8_t const *p_ad_data,
                                                           uint8_t ad_len);
 ...
 *
 * */
tuya_ble_status_t tuya_ble_storage_private_data(tuya_ble_private_data_type private_data_type,
 ...
 *
 * */
tuya_ble_status_t tuya_ble_ecc_shared_secret_compute_secp256r1(uint8_t *public_key,
 ...
 *
 * */
tuya_ble_status_t tuya_ble_ecc_sign_secp256r1(const uint8_t *p_sk, const uint8_t *p_data,
                                              uint32_t data_size, uint8_t *p_sig);
 ...
 *
 * */
tuya_ble_status_t tuya_ble_ecc_verify_secp256r1(const uint8_t *p_pk, const uint8_t *p_hash,
                                                uint32_t hash_size, const uint8_t *p_sig);
