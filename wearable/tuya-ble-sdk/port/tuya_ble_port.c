 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_gap_advertising_adv_data_update(uint8_t const *p_ad_data,
                                                                           uint8_t ad_len)
{
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_gap_advertising_scan_rsp_data_update(
    uint8_t const *p_sr_data, uint8_t sr_len)
{
    return TUYA_BLE_SUCCESS;
}
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_device_info_characteristic_value_update(
    uint8_t const *p_data, uint8_t data_len)
{
    return TUYA_BLE_SUCCESS;
}
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_timer_create(void **p_timer_id,
                                                        uint32_t timeout_value_ms, tuya_ble_timer_mode mode, tuya_ble_timer_handler_t timeout_handler)
{
    return TUYA_BLE_SUCCESS;
}
/**
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_nv_write(uint32_t addr, const uint8_t *p_data,
                                                    uint32_t size)
{
    return TUYA_BLE_SUCCESS;
}
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_common_uart_send_data(const uint8_t *p_data,
                                                                 uint16_t len)
{
    return TUYA_BLE_SUCCESS;
}
 ...
 *
 * */
__TUYA_BLE_WEAK bool tuya_ble_os_task_create(void **pp_handle, const char *p_name,
                                             void (*p_routine)(void *), void *p_param, uint16_t stack_size, uint16_t priority)
{
    return true;
}
/**
 ...
 *
 * */
__TUYA_BLE_WEAK bool tuya_ble_os_msg_queue_create(void **pp_handle, uint32_t msg_num,
                                                  uint32_t msg_size)
{
    return true;
}
...
/**
    ...
    */
__TUYA_BLE_WEAK bool tuya_ble_aes128_ecb_encrypt(uint8_t *key, uint8_t *input, uint16_t input_len,
                                                 uint8_t *output)
{
    return true;
}
...
/**
    ...
    * @note   least significant octet of encrypted data corresponds to encypted[0]
*/
__TUYA_BLE_WEAK bool tuya_ble_aes128_ecb_decrypt(uint8_t *key, uint8_t *input, uint16_t input_len,
                                                 uint8_t *output)
{
    return true;
}
/**
    ...
    * @note   least significant octet of encrypted data corresponds to encypted[0]
    */
__TUYA_BLE_WEAK bool tuya_ble_aes128_cbc_encrypt(uint8_t *key, uint8_t *iv, uint8_t *input,
                                                 uint16_t input_len, uint8_t *output)
{
    return true;
}
/**
    ...
    * @note   least significant octet of encrypted data corresponds to encypted[0]
    */
__TUYA_BLE_WEAK bool tuya_ble_aes128_cbc_decrypt(uint8_t *key, uint8_t *iv, uint8_t *input,
                                                 uint16_t input_len, uint8_t *output)
{
    return true;
}
...
/**
    ...
    * @note
    */
__TUYA_BLE_WEAK bool tuya_ble_sha256_crypt(const uint8_t *input, uint16_t input_len,
                                           uint8_t *output)
{
    return true;
}
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_storage_private_data(tuya_ble_private_data_type
                                                                private_data_type, uint8_t *p_data, uint32_t data_size)
{
    return TUYA_BLE_SUCCESS;
}
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_ecc_keypair_gen_secp256r1(uint8_t *public_key,
                                                                     uint8_t *private_key)
{
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_ecc_shared_secret_compute_secp256r1(uint8_t *public_key,
                                                                               uint8_t *private_key, uint8_t *secret_key)
{
    return TUYA_BLE_ERR_INVALID_STATE;
}
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_ecc_sign_secp256r1(const uint8_t *p_sk,
                                                              const uint8_t *p_data, uint32_t data_size, uint8_t *p_sig)
{
    return TUYA_BLE_ERR_INVALID_STATE;
}
 ...
 *
 * */
__TUYA_BLE_WEAK tuya_ble_status_t tuya_ble_ecc_verify_secp256r1(const uint8_t *p_pk,
                                                                const uint8_t  *p_data, uint32_t data_size, const uint8_t *p_sig)
{
...
/**
    ...
    * @note
    */
__TUYA_BLE_WEAK bool tuya_ble_hmac_sha1_crypt(const uint8_t *key, uint32_t key_len,
...
/**
    ...
    * @note
    */
__TUYA_BLE_WEAK bool tuya_ble_hmac_sha256_crypt(const uint8_t *key, uint32_t key_len,
                                                const uint8_t *input, uint32_t input_len, uint8_t *output)
{
    return true;
}
