...
#include <stdlib.h>
extern void *miwear_realloc(void *ptr, size_t size);
extern void miwear_free(void *ptr);
#define pb_realloc(ptr, size) miwear_realloc(ptr, size)
#define pb_free(ptr) miwear_free(ptr)
#endif
#endif
