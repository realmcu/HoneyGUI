...
```xml
<fatherType a1="xx" a2="xx" a3="xx" a4="xx">父节点 

    <childType a1="xx" a2="xx" a3="xx">子节点一</childType> 
    <childType a1="xx" a2="xx" a3="xx">子节点二
        <childType a1="xx" a2="xx" a3="xx">子节点三</childType> 
        <childType a1="xx" a2="xx" a3="xx">子节点四</childType> 
    </childType> 
</fatherType> 
```
## 规格 
...
| type(animateTransform) |动画类型|rotate|
| from |动画起始值|number|
| to(animateTransform) |动画终点值|number|
| dur |动画时长|number|
