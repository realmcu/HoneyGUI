...
设置透明度
~~~~~~~~~~~~~
使用 :cpp:any:`gui_view_set_opacity` 设置控件透明度，可实现 view 重叠显示效果。


获取当前显示的视图控件指针
~~~~~~~~~~~~~~~~~~~~~~~~~~
使用 :cpp:any:`gui_view_get_current` 函数可以获取当前显示的视图控件指针，可以搭配 :cpp:any:`gui_view_switch_direct` 使用，将当前 view 切换。
