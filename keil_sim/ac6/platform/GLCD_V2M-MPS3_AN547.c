                            ...
                            const arm_2d_region_t *ptRegion)
{
    ...
    for (i = (int32_t)((tDrawRegion.iHeight - 1) * tDrawRegion.iWidth); i > -1;
         i -= tDrawRegion.iWidth)
    {
...
/**
  ...
  \returns
   ...
   - \b -1: function failed
*/
int32_t GLCD_DrawBitmap(uint32_t x, uint32_t y, uint32_t width, uint32_t height,
