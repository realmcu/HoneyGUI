 ...
 */
LV_ATTRIBUTE_FAST_MEM static inline lv_color_t lv_color_mix(lv_color_t c1, lv_color_t c2,
                                                            uint8_t mix)
{
    lv_color_t ret;
 ...
 */
LV_ATTRIBUTE_FAST_MEM static inline lv_color_t lv_color_mix_premult(uint16_t *premult_c1,
 ...
 */
LV_ATTRIBUTE_FAST_MEM static inline void lv_color_mix_with_alpha(lv_color_t bg_color,
                                                                 lv_opa_t bg_opa,
                                                                 ...
                                                                 lv_color_t *res_color, lv_opa_t *res_opa)
{
    ...
    else
    {
            ...
            bg_color.full != bg_color_save.full)
        {
            ...
            if (res_opa_saved != 0)
            {
                ratio = (uint16_t)((uint16_t)fg_opa * 255) / res_opa_saved;
            }
...
static inline uint8_t lv_color_brightness(lv_color_t color)
{
    ...
    uint16_t bright = (uint16_t)(3u * LV_COLOR_GET_R32(c32) + LV_COLOR_GET_B32(
                                     c32) + 4u * LV_COLOR_GET_G32(c32));
...
static inline lv_color_t lv_color_hex(uint32_t c)
{
    ...
    r.full = (uint16_t)(((c & 0xF80000) >> 16) | ((c & 0xFC00) >> 13) | ((c & 0x1C00) << 3) | ((
                            c & 0xF8) << 5));
#endif
    return r;
#elif LV_COLOR_DEPTH == 32
